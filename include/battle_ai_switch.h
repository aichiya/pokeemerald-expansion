...
enum ShouldSwitchScenario
{
    ...
    SHOULD_SWITCH_MANA_DISTURPTOR,
    SHOULD_SWITCH_MANA_DISTURPTOR_STATS_RAISED,
    SHOULD_SWITCH_MISFORTUNE_AURA,
    SHOULD_SWITCH_MISFORTUNE_AURA_STATS_RAISED,
    SHOULD_SWITCH_DOUR_ECHO,
    SHOULD_SWITCH_DOUR_ECHO_STATS_RAISED,
    SHOULD_SWITCH_MANIC_ECHO,
    SHOULD_SWITCH_MANIC_ECHO_STATS_RAISED,
    SHOULD_SWITCH_LAST_CADENZA,
    SHOULD_SWITCH_LAST_CADENZA_STATS_RAISED,
