...
extern const u8 Move_ULTRA_INSTINCT[];
extern const u8 Move_A_TRANCE[];
extern const u8 Move_TWIN_SPARK[];
...
extern const u8 Move_SPIRIT_CAMERA[];
extern const u8 Move_RAGING_DEMON[];
