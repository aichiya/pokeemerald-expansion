...
extern const u8 BattleScript_WeatherAbilityActivatesNoPopup[];
...
extern const u8 BattleScript_PsychicSurgeActivatesNoPopup[];
extern const u8 BattleScript_GrassySurgeActivates[];
extern const u8 BattleScript_GrassySurgeActivatesNoPopup[];
extern const u8 BattleScript_MistySurgeActivates[];
extern const u8 BattleScript_MistySurgeActivatesNoPopup[];
extern const u8 BattleScript_ElectricSurgeActivates[];
extern const u8 BattleScript_ElectricSurgeActivatesNoPopup[];
...
extern const u8 BattleScript_MoveEffectLightScreen[]; // Check
extern const u8 BattleScript_MoveEffectReflect[]; // Check
extern const u8 BattleScript_MoveEffectSafeguard[]; // Check
extern const u8 BattleScript_MoveEffectMist[]; // Check
...
extern const u8 BattleScript_StasisGazeActivatesGenericStatIncrease[];
...
extern const u8 BattleScript_UBWActivatesNoPopup[];
...
extern const u8 BattleScript_DarknessSurgeActivatesNoPopup[];
...
extern const u8 BattleScript_MiasmaSurgeActivatesNoPopup[];
