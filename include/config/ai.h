...
#define SHOULD_SWITCH_MANA_DISTURPTOR_PERCENTAGE                    25
#define SHOULD_SWITCH_MANA_DISTURPTOR_STATS_RAISED_PERCENTAGE       10
#define SHOULD_SWITCH_MISFORTUNE_AURA_PERCENTAGE                    25
#define SHOULD_SWITCH_MISFORTUNE_AURA_STATS_RAISED_PERCENTAGE       10
#define SHOULD_SWITCH_DOUR_ECHO_PERCENTAGE                          25
#define SHOULD_SWITCH_DOUR_ECHO_STATS_RAISED_PERCENTAGE             10
#define SHOULD_SWITCH_MANIC_ECHO_PERCENTAGE                         25
#define SHOULD_SWITCH_MANIC_ECHO_STATS_RAISED_PERCENTAGE            10
#define SHOULD_SWITCH_LAST_CADENZA_PERCENTAGE                       25
#define SHOULD_SWITCH_LAST_CADENZA_STATS_RAISED_PERCENTAGE          10
...
#define AI_DOUBLE_TARGET_COORDINATION            TRUE // Reduce redundant single-target attacks when an ally has already chosen a reliable KO. Set FALSE for independent targeting.
