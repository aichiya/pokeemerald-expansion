...
#define WE_FLAG_NO_ENCOUNTER        FLAG_NO_ENCOUNTER // If this flag is set, wild encounters will be disabled.
...
#define WE_SMART_WILD_AI_FLAG        FLAG_SMART_WILD_AI_FLAG // If this flag is set, wild Pokémon will become smart, with all AI flags enabled.
#define WE_FLAG_NO_CATCHING          FLAG_NO_CATCHING        // If this flag is set, the ability to catch wild Pokémon is disabled.
#define WE_FLAG_NO_RUNNING           FLAG_NO_RUNNING_AWAY    // If this flag is set, the ability to escape from wild battles is disabled. Also makes Roar/Whirlwind and Teleport (under Gen8) fail.
