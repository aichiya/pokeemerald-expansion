...
#define ABILITY_OFFICIAL_END            ABILITY_POISON_PUPPETEER

#define ABILITY_ULTRA_EGO               (ABILITY_OFFICIAL_END + 1)
#define ABILITY_MAKAI_GODDESS           (ABILITY_OFFICIAL_END + 2)
#define ABILITY_SHICHININ_MISAKI        (ABILITY_OFFICIAL_END + 3)
#define ABILITY_SCARY_GLANCE            (ABILITY_OFFICIAL_END + 4)
#define ABILITY_DIMENSION_OVERSEER      (ABILITY_OFFICIAL_END + 5)
#define ABILITY_DOLL_WALL               (ABILITY_OFFICIAL_END + 6)
#define ABILITY_DIVINE_HAND             (ABILITY_OFFICIAL_END + 7)
#define ABILITY_TIME_JACKER             (ABILITY_OFFICIAL_END + 8)
#define ABILITY_GRIMOIRE_USER           (ABILITY_OFFICIAL_END + 9)
#define ABILITY_DEUS_EX_MACHINA         (ABILITY_OFFICIAL_END + 10)
#define ABILITY_SKILLED_MAGICIAN        (ABILITY_OFFICIAL_END + 11)
#define ABILITY_DELTA_FORCE_1           (ABILITY_OFFICIAL_END + 12)
#define ABILITY_DELTA_FORCE_2           (ABILITY_OFFICIAL_END + 13)
#define ABILITY_DELTA_FORCE_3           (ABILITY_OFFICIAL_END + 14)
#define ABILITY_WINNING_COMBINATION_1   (ABILITY_OFFICIAL_END + 15) // Reimu & Marisa
#define ABILITY_WINNING_COMBINATION_2   (ABILITY_OFFICIAL_END + 16) // Aki Sisters
#define ABILITY_WINNING_COMBINATION_3   (ABILITY_OFFICIAL_END + 17) // Yorigami Sisters
#define ABILITY_GREAT_BLOOMING          (ABILITY_OFFICIAL_END + 18)
#define ABILITY_FANTASY_BREAKER         (ABILITY_OFFICIAL_END + 19)
#define ABILITY_PURE_WHITE              (ABILITY_OFFICIAL_END + 20)
#define ABILITY_MANA_DISTURPTOR         (ABILITY_OFFICIAL_END + 21)
#define ABILITY_KRIS_WORKS              (ABILITY_OFFICIAL_END + 22)
#define ABILITY_PRIEST_HUNTER           (ABILITY_OFFICIAL_END + 23)
#define ABILITY_ADVENT                  (ABILITY_OFFICIAL_END + 24)
#define ABILITY_SECOND_ADVENT           (ABILITY_OFFICIAL_END + 25)
#define ABILITY_HAKUREI_BARRIER         (ABILITY_OFFICIAL_END + 26)
#define ABILITY_HAKUREI_MIKO            (ABILITY_OFFICIAL_END + 27)
#define ABILITY_SABOTEN_CORE            (ABILITY_OFFICIAL_END + 28)
#define ABILITY_PRISMA_ZWEI             (ABILITY_OFFICIAL_END + 29)
#define ABILITY_KALEID_RUBY             (ABILITY_OFFICIAL_END + 30)
#define ABILITY_KALEID_SAPPHIRE         (ABILITY_OFFICIAL_END + 31)
#define ABILITY_ULTRA_MEDICINE          (ABILITY_OFFICIAL_END + 32)
#define ABILITY_SCULPTOR_GOD            (ABILITY_OFFICIAL_END + 33)
#define ABILITY_POSTER_GIRL             (ABILITY_OFFICIAL_END + 34)
#define ABILITY_WORLD_END_GARDEN        (ABILITY_OFFICIAL_END + 35)
#define ABILITY_FOCUS                   (ABILITY_OFFICIAL_END + 36)
#define ABILITY_MIRROR_WALL             (ABILITY_OFFICIAL_END + 37)
#define ABILITY_MISFORTUNE_AURA         (ABILITY_OFFICIAL_END + 38)
#define ABILITY_FLORA_ELVIS             (ABILITY_OFFICIAL_END + 39)
#define ABILITY_FORTISSIMO              (ABILITY_OFFICIAL_END + 40)
#define ABILITY_LIFE_FORCE              (ABILITY_OFFICIAL_END + 41)
#define ABILITY_MULTITYPE_LEGEND        (ABILITY_OFFICIAL_END + 42)
#define ABILITY_DARKNESS_SURGE          (ABILITY_OFFICIAL_END + 43)
#define ABILITY_TSUBAME_GAESHI          (ABILITY_OFFICIAL_END + 44)
#define ABILITY_MIASMA_SURGE            (ABILITY_OFFICIAL_END + 45)
#define ABILITY_ULTRA_MEDICINE_V2       (ABILITY_OFFICIAL_END + 46)
#define ABILITY_RIDE_SUMMON             (ABILITY_OFFICIAL_END + 47)
#define ABILITY_PUPPETEER               (ABILITY_OFFICIAL_END + 48)

#define ABILITY_UNOFFICIAL_END          ABILITY_PUPPETEER

#define ABILITIES_COUNT_GEN9 (ABILITY_UNOFFICIAL_END + 1)
