...
#define ABILITY_DIMENSION_SEER          (ABILITY_OFFICIAL_END + 5)
...
#define ABILITY_ILLUSIONARY_GIRL        (ABILITY_OFFICIAL_END + 10)
...
#define ABILITY_DOUBLE_HEROINES         (ABILITY_OFFICIAL_END + 15) // Reimu & Marisa
#define ABILITY_AUTUMN_GODDESSES        (ABILITY_OFFICIAL_END + 16) // Aki Sisters
#define ABILITY_YORIGAMI_SISTERS        (ABILITY_OFFICIAL_END + 17) // Yorigami Sisters
...
#define ABILITY_BLADE_WORKS             (ABILITY_OFFICIAL_END + 22)
