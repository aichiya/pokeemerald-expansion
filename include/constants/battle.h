...
#define B_WEATHER_SHADOW_SKY_NORMAL   (1 << BATTLE_WEATHER_SHADOW_SKY)
#define B_WEATHER_SHADOW_SKY_DEEP     (1 << BATTLE_WEATHER_SHADOW_SKY_DEEP)
#define B_WEATHER_SHADOW_SKY          (B_WEATHER_SHADOW_SKY_NORMAL | B_WEATHER_SHADOW_SKY_DEEP)
...
#define B_WEATHER_DAMAGING_ANY  (B_WEATHER_HAIL | B_WEATHER_SANDSTORM | B_WEATHER_SHADOW_SKY_NORMAL | B_WEATHER_SHADOW_SKY)
...
#define B_WEATHER_PRIMAL_ANY    (B_WEATHER_RAIN_PRIMAL | B_WEATHER_SUN_PRIMAL | B_WEATHER_STRONG_WINDS | B_WEATHER_SHADOW_SKY_DEEP)
