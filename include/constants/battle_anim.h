...
#define ANIM_TAG_FLOWER_SINGLE              (LAST_ANIM_TAG_EXPANSION + 19)
#define ANIM_TAG_CIRCLE_OF_LIGHT_FF         (LAST_ANIM_TAG_EXPANSION + 20)
#define ANIM_TAG_STAR_STELLAR               (LAST_ANIM_TAG_EXPANSION + 21)
#define ANIM_TAG_MILKY_STELLAR              (LAST_ANIM_TAG_EXPANSION + 22)
...
#define ANIM_TAG_MOON_TIARA                 (LAST_ANIM_TAG_EXPANSION + 35)

#define ANIM_TAG_COUNT                      GET_TRUE_SPRITE_INDEX(ANIM_TAG_MOON_TIARA + 1)
