...
#define STRINGID_LAST_EXPANSION                       STRINGID_PKMNSENTTOPCAFTERCATCH
...
#define STRINGID_SETUPHAKUREIBARRIER                  (STRINGID_LAST_EXPANSION + 13)
#define STRINGID_CAUSESCHAOSONTHEOPPOSINGSIDE         (STRINGID_LAST_EXPANSION + 14)
#define STRINGID_TEAMTRAPPEDINTHEWORLDENDGARDEN       (STRINGID_LAST_EXPANSION + 15)
#define STRINGID_PKMNHURTBYWORLDENDGARDEN             (STRINGID_LAST_EXPANSION + 16)
#define STRINGID_WORLDENDGARDENPREVENTSCOURTCHANGE    (STRINGID_LAST_EXPANSION + 17)
#define STRINGID_PKMNCUTSACCWITH                      (STRINGID_LAST_EXPANSION + 18)
#define STRINGID_FLORAELVISSAFEGUARD                  (STRINGID_LAST_EXPANSION + 19)
#define STRINGID_PKMNRAISEDATTACK                     (STRINGID_LAST_EXPANSION + 20)
#define STRINGID_DIVINETREEBLESSING                   (STRINGID_LAST_EXPANSION + 21)
#define STRINGID_ADVENTLYCORISTRAPPED                 (STRINGID_LAST_EXPANSION + 22)

#define STRINGID_LAST_CUSTOM_ADDED                    STRINGID_ADVENTLYCORISTRAPPED
...
#define B_MSG_SWITCHIN_FANTASY_BREAKER  17
#define B_MSG_SWITCHIN_TIME_JACKER      18
...
#define B_MSG_WRAPPED_ADVENT_LYCORIS 10
...
#define B_MSG_TRAPPED_IN_THE_WORLD_END_GARDEN 4
...
#define B_MSG_HURT_BY_WORLD_END_GARDEN 4
