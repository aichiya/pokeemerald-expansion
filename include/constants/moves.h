...
#define MOVE_A_TRANCE               (MOVE_END_OFFICIAL + 2)
...
#define MOVE_SCULPTING_ART          (MOVE_END_OFFICIAL + 10)
#define MOVE_PLASMA_BLADE           (MOVE_END_OFFICIAL + 11)
#define MOVE_01_CRUSHER             (MOVE_END_OFFICIAL + 12)
...
#define MOVE_FIVE_ELEMENT           (MOVE_END_OFFICIAL + 26)
#define MOVE_WIDE_SLASH             (MOVE_END_OFFICIAL + 27)
#define MOVE_SPIN_SLASH             (MOVE_END_OFFICIAL + 28)
#define MOVE_VACUUM_CUT             (MOVE_END_OFFICIAL + 29)

#define MOVE_ADDED_MODERN_END       MOVE_VACUUM_CUT
...
#define MOVE_SHADOW_BLITZ           (MOVE_END_CLASSIC + 1)
#define MOVE_SHADOW_RUSH            (MOVE_END_CLASSIC + 2)
#define MOVE_SHADOW_BREAK           (MOVE_END_CLASSIC + 3)
#define MOVE_SHADOW_END             (MOVE_END_CLASSIC + 4)
#define MOVE_SHADOW_WAVE            (MOVE_END_CLASSIC + 5)
#define MOVE_SHADOW_RAVE            (MOVE_END_CLASSIC + 6)
#define MOVE_SHADOW_STORM           (MOVE_END_CLASSIC + 7)
#define MOVE_SHADOW_FIRE            (MOVE_END_CLASSIC + 8)
#define MOVE_SHADOW_BOLT            (MOVE_END_CLASSIC + 9)
#define MOVE_SHADOW_CHILL           (MOVE_END_CLASSIC + 10)
#define MOVE_SHADOW_BLAST           (MOVE_END_CLASSIC + 11)
#define MOVE_SHADOW_SKY             (MOVE_END_CLASSIC + 12)
#define MOVE_SHADOW_HOLD            (MOVE_END_CLASSIC + 13)
#define MOVE_SHADOW_MIST            (MOVE_END_CLASSIC + 14)
#define MOVE_SHADOW_PANIC           (MOVE_END_CLASSIC + 15)
#define MOVE_SHADOW_DOWN            (MOVE_END_CLASSIC + 16)
#define MOVE_SHADOW_SHED            (MOVE_END_CLASSIC + 17)
#define MOVE_SHADOW_HALF            (MOVE_END_CLASSIC + 18)

#define MOVE_END_SHADOW_MOVES       MOVE_SHADOW_HALF

#define MOVE_END_ADDED      MOVE_END_SHADOW_MOVES
