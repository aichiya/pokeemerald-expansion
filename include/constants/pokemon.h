...
{
    BODY_COLOR_RED,
    FRANCHISE_ORIGIN_POKEMON = BODY_COLOR_RED,
    BODY_COLOR_BLUE,
    FRANCHISE_ORIGIN_MOEMON = BODY_COLOR_BLUE,
    BODY_COLOR_YELLOW,
    FRANCHISE_ORIGIN_YUYUYUI = BODY_COLOR_YELLOW,
    BODY_COLOR_GREEN,
    FRANCHISE_ORIGIN_TOUHOU = BODY_COLOR_GREEN,
    BODY_COLOR_BLACK,
    FRANCHISE_ORIGIN_SEIHOU = BODY_COLOR_BLACK,
    BODY_COLOR_BROWN,
    FRANCHISE_ORIGIN_KEY = BODY_COLOR_BROWN,
    BODY_COLOR_PURPLE,
    FRANCHISE_ORIGIN_BGHS = BODY_COLOR_PURPLE,
    BODY_COLOR_GRAY,
    FRANCHISE_ORIGIN_PRECURE = BODY_COLOR_GRAY,
    BODY_COLOR_WHITE,
    FRANCHISE_ORIGIN_OTHER = BODY_COLOR_WHITE,
    BODY_COLOR_PINK,
    FRANCHISE_ORIGIN_UNIDENTIFIED = BODY_COLOR_PINK,
};
