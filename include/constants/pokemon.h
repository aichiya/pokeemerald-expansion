...
#define FRANCHISE_ORIGIN_POKEMON      0
#define FRANCHISE_ORIGIN_MOEMON       1
#define FRANCHISE_ORIGIN_YUYUYUI      2
#define FRANCHISE_ORIGIN_TOUHOU       3
#define FRANCHISE_ORIGIN_SEIHOU       4
#define FRANCHISE_ORIGIN_KEY          5
#define FRANCHISE_ORIGIN_BGHS         6
#define FRANCHISE_ORIGIN_PRECURE      7
#define FRANCHISE_ORIGIN_OTHER        8
#define FRANCHISE_ORIGIN_UNIDENTIFIED 9
...
#define EVO_LEVEL_VOID                    53     // Pokémon levels up after having specific conditions
