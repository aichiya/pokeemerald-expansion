...
enum RandomTag
{
    ...
    RNG_AI_SWITCH_MANA_DISTURPTOR,
    RNG_AI_SWITCH_MISFORTUNE_AURA,
    RNG_AI_SWITCH_DOUR_ECHO,
    RNG_AI_SWITCH_MANIC_ECHO,
    RNG_AI_SWITCH_LAST_CADENZA,
    ...
    RNG_ULTRA_MARCH,
    RNG_ULTRA_BEAUTY,
    RNG_ULTRA_EGO_INCREASE,
    RNG_GRACE_OF_DREAM_INCREASE,
    RNG_LUNACY_INCREASE,
};
