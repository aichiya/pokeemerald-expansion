...
static bool32 FindMonThatAbsorbsOpponentsMove(u32 battler)
{
    ...
    if (predictedType == TYPE_NEW_FIRE)
    {
        absorbingTypeAbilities[numAbsorbingAbilities++] = ABILITY_FLASH_FIRE;
    }
    else if (predictedType == TYPE_NEW_WATER || (isOpposingBattlerChargingOrInvulnerable && incomingType == TYPE_NEW_WATER))
    {
    ...
    else if (predictedType == TYPE_NEW_ELECTRIC || (isOpposingBattlerChargingOrInvulnerable && incomingType == TYPE_NEW_ELECTRIC))
    {
    ...
    else if (predictedType == TYPE_NEW_NATURE || (isOpposingBattlerChargingOrInvulnerable && incomingType == TYPE_NEW_NATURE))
    {
        absorbingTypeAbilities[numAbsorbingAbilities++] = ABILITY_SAP_SIPPER;
    }
    else if (predictedType == TYPE_NEW_EARTH || (isOpposingBattlerChargingOrInvulnerable && incomingType == TYPE_NEW_EARTH))
    {
