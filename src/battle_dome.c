...
static const u8 *const sBattleDomeOpponentStatsTexts[] =
{
    ...
    [DOME_TEXT_WELL_BALANCED] = COMPOUND_STRING("Raises Fragmon in a well-balanced way."),
};
...
static int GetTypeEffectivenessPoints(enum Move move, enum Species targetSpecies, int mode)
{
    ...
    if ((defAbility == ABILITY_LEVITATE || defAbility == ABILITY_EELEVATE) && moveType == TYPE_NEW_EARTH)
    {
