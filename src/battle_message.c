...
static const u8 sText_WildPkmnFled[] = _("{PLAY_SE SE_FLEE}The fragment of {B_BUFF1} fled!");
...
static const u8 sText_WildPkmnAppeared[] = _("A fragment of {B_OPPONENT_MON1_NAME} appeared!\p");
static const u8 sText_LegendaryPkmnAppeared[] = _("A fragment of {B_OPPONENT_MON1_NAME} appeared!\p");
static const u8 sText_WildPkmnAppearedPause[] = _("A fragment of {B_OPPONENT_MON1_NAME} appeared!{PAUSE 127}");
static const u8 sText_TwoWildPkmnAppeared[] = _("A fragment of {B_OPPONENT_MON1_NAME} and\na fragment of {B_OPPONENT_MON2_NAME} appeared!\p");
...
static const u8 sText_WildPkmnPrefix[] = _("The fragment of ");
