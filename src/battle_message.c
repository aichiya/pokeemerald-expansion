...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PLAYERWHITEOUT]                       = COMPOUND_STRING("You have no more member that can fight!\p"),
    ...
    [STRINGID_HITXTIMES]                            = COMPOUND_STRING("Hit {B_BUFF1} time{B_BUFF2}!"),
    ...
    [STRINGID_PKMNSAPPEDBYLEECHSEED]                = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s health is sapped by the draining seed!"),
    ...
    [STRINGID_PKMNSHEDLEECHSEED]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} was freed from the sapping seed!"),
    ...
    [STRINGID_FAINTINTHREE]                         = COMPOUND_STRING("All battler that heard the song will faint in three turns!"),
    ...
    [STRINGID_ENEMYABOUTTOSWITCHPKMN]               = COMPOUND_STRING("{B_TRAINER1_NAME_WITH_CLASS} is about to send out {B_BUFF2}. Will you switch your battler?"),
    ...
    [STRINGID_POINTEDSTONESFLOAT]                   = COMPOUND_STRING("Sharp tusks float in the air on {B_DEF_TEAM2} side!"),
    ...
    [STRINGID_HELDITEMSLOSEEFFECTS]                 = COMPOUND_STRING("It created a bizarre area in which battler's held items lose their effects!"),
    ...
    [STRINGID_MEGAEVOREACTING]                      = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_LAST_ITEM} is reacting to {B_ATK_TRAINER_NAME}'s Omni Ring!"), //actually displays the type of mega ring in inventory, but we didnt implement them :(
    ...
    [STRINGID_PKMNSWILLPERISHIN3TURNS]              = COMPOUND_STRING("Both battlers will faint in three turns!"),
    ...
    [STRINGID_PKMNREVERTEDTOPRIMAL]                 = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s Temporal Syncronization! Transforming into past self!"),
    ...
    [STRINGID_BOTHCANNOLONGERESCAPE]                = COMPOUND_STRING("Neither battler can run away!"),
    ...
    [STRINGID_FANTASYBREAKERENTERS]                 = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} is ready to destroy fantasies!"),
    [STRINGID_YORIGAMICURSE]                        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} laid a curse on {B_DEF_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNRAISEDEVASION]                    = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY} raised its evasion!"),
    ...
    [STRINGID_PKMNFLUFFIEDINTO]                     = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} got fluffied and transformed into {B_BUFF1}!"),
    [STRINGID_PARTYGOTWIPEDOUT]                     = COMPOUND_STRING("The {B_DEF_TEAM1} party got wiped out."),
    ...
    [STRINGID_PKMNCUTSACCWITH]                      = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY} lowers {B_DEF_NAME_WITH_PREFIX}'s Accuracy!"),
    [STRINGID_FLORAELVISSAFEGUARD]                  = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY} activates Safeguard!"),
    [STRINGID_PKMNRAISEDATTACK]                     = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY} raised its attack!"),
    ...
    [STRINGID_FAINTINONE]                           = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} will faint in the next turn!"),
...
const u8 *const gRefereeStringsTable[] =
{
    ...
    [B_MSG_REF_JUDGE_MIND]         = COMPOUND_STRING("REFEREE: Judging category 1, Mind! The Fragmon showing the most guts!\p"),
    [B_MSG_REF_JUDGE_SKILL]        = COMPOUND_STRING("REFEREE: Judging category 2, Skill! The Fragmon using moves the best!\p"),
    [B_MSG_REF_JUDGE_BODY]         = COMPOUND_STRING("REFEREE: Judging category 3, Body! The Fragmon with the most vitality!\p"),
...
static const u8 *BattleStringGetOpponentNameByTrainerId(u16 trainerId, u8 *text, u8 multiplayerId, enum BattlerId battler)
{
    ...
    else
    {
        ...
        else if (trainerClass == TRAINER_CLASS_RIVAL_EARLY_FRLG || trainerClass == TRAINER_CLASS_RIVAL_LATE_FRLG || trainerClass == TRAINER_CLASS_CHAMPION_FRLG)
