...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_PKMNRAISEDEVASION]                    = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nraised its evasion!"),
    [STRINGID_TIMEJACKERENTERS]                     = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} is making the time wierd!"),
    [STRINGID_LEECHSEEDHEALSABILITYPUREWHITE]       = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} got healed from\nthe Leech Seed due to {B_ATK_ABILITY}!"),
