...
void FillPartnerParty(u16 trainerId)
{
    ...
    if (trainerId > TRAINER_PARTNER(PARTNER_NONE))
    {
        ...
        if (trainerId == TRAINER_PARTNER(PARTNER_STEVEN))
            ...
            partnerGen.otID = OTID_STRUCT_PRESET(PARTNER2_OTID);
        else if (trainerId == TRAINER_PARTNER(PARTNER_HEMO))
            partnerGen.otID = OTID_STRUCT_PRESET(0x0A1C0A1C);
        else if (trainerId == TRAINER_PARTNER(PARTNER_UDA))
            partnerGen.otID = OTID_STRUCT_PRESET(0x01BC01BC);
        else if (trainerId == TRAINER_PARTNER(PARTNER_TENCHO))
            partnerGen.otID = OTID_STRUCT_PRESET(0x1B391B39);
