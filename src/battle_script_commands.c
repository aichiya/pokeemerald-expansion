...
static const u16 sNaturePowerMoves[BATTLE_ENVIRONMENT_COUNT] =
{
    ...
    [BATTLE_ENVIRONMENT_BLANK_GBC]  = MOVE_CORE_ENFORCER,
    [BATTLE_ENVIRONMENT_GRASS_MONO]      = MOVE_ENERGY_BALL,
    [BATTLE_ENVIRONMENT_LONG_GRASS_MONO] = MOVE_ENERGY_BALL,
    [BATTLE_ENVIRONMENT_SAND_MONO]       = MOVE_EARTH_POWER,
    [BATTLE_ENVIRONMENT_WATER_MONO]      = MOVE_HYDRO_PUMP,
    [BATTLE_ENVIRONMENT_POND_MONO]       = MOVE_HYDRO_PUMP,
    [BATTLE_ENVIRONMENT_MOUNTAIN_MONO]   = MOVE_EARTH_POWER,
    [BATTLE_ENVIRONMENT_CAVE_MONO]       = MOVE_EARTH_POWER,
    [BATTLE_ENVIRONMENT_BUILDING_MONO]   = MOVE_TRI_ATTACK,
    [BATTLE_ENVIRONMENT_PLAIN_MONO]      = MOVE_TRI_ATTACK,
    ...
    [BATTLE_ENVIRONMENT_CAVE]       = MOVE_EARTH_POWER,
    [BATTLE_ENVIRONMENT_BUILDING]   = MOVE_TRI_ATTACK,
    [BATTLE_ENVIRONMENT_BLANK_GBC]  = MOVE_TRI_ATTACK,
    [BATTLE_ENVIRONMENT_GRASS_MONO]      = MOVE_ENERGY_BALL,
    [BATTLE_ENVIRONMENT_LONG_GRASS_MONO] = MOVE_ENERGY_BALL,
    [BATTLE_ENVIRONMENT_SAND_MONO]       = MOVE_EARTH_POWER,
    [BATTLE_ENVIRONMENT_WATER_MONO]      = MOVE_HYDRO_PUMP,
    ...
    [BATTLE_ENVIRONMENT_BUILDING]   = MOVE_TRI_ATTACK,
    [BATTLE_ENVIRONMENT_BLANK_GBC]  = MOVE_TRI_ATTACK,
    [BATTLE_ENVIRONMENT_GRASS_MONO]      = MOVE_SEED_BOMB,
    [BATTLE_ENVIRONMENT_LONG_GRASS_MONO] = MOVE_SEED_BOMB,
    [BATTLE_ENVIRONMENT_SAND_MONO]       = MOVE_EARTHQUAKE,
    [BATTLE_ENVIRONMENT_WATER_MONO]      = MOVE_HYDRO_PUMP,
    [BATTLE_ENVIRONMENT_POND_MONO]       = MOVE_HYDRO_PUMP,
    [BATTLE_ENVIRONMENT_MOUNTAIN_MONO]   = MOVE_EARTHQUAKE,
    [BATTLE_ENVIRONMENT_CAVE_MONO]       = MOVE_EARTHQUAKE,
    [BATTLE_ENVIRONMENT_BUILDING_MONO]   = MOVE_TRI_ATTACK,
    [BATTLE_ENVIRONMENT_PLAIN_MONO]      = MOVE_EARTHQUAKE,
    ...
    [BATTLE_ENVIRONMENT_WATER_MONO]      = MOVE_HYDRO_PUMP,
    [BATTLE_ENVIRONMENT_POND_MONO]       = MOVE_HYDRO_PUMP,
    [BATTLE_ENVIRONMENT_MOUNTAIN_MONO]   = MOVE_ROCK_SLIDE,
    [BATTLE_ENVIRONMENT_CAVE_MONO]       = MOVE_ROCK_SLIDE,
    [BATTLE_ENVIRONMENT_BUILDING_MONO]   = MOVE_TRI_ATTACK,
    [BATTLE_ENVIRONMENT_PLAIN_MONO]      = MOVE_EARTHQUAKE,
    [BATTLE_ENVIRONMENT_PLAIN]      = MOVE_EARTHQUAKE,
    [BATTLE_ENVIRONMENT_SNOW]       = MOVE_BLIZZARD,
    ...
    [BATTLE_ENVIRONMENT_BLANK_GBC]  = MOVE_TRI_ATTACK,
    [BATTLE_ENVIRONMENT_GRASS_MONO]      = MOVE_STUN_SPORE,
    [BATTLE_ENVIRONMENT_LONG_GRASS_MONO] = MOVE_RAZOR_LEAF,
    [BATTLE_ENVIRONMENT_SAND_MONO]       = MOVE_EARTHQUAKE,
    [BATTLE_ENVIRONMENT_WATER_MONO]      = MOVE_SURF,
    [BATTLE_ENVIRONMENT_POND_MONO]       = MOVE_BUBBLE_BEAM,
    [BATTLE_ENVIRONMENT_MOUNTAIN_MONO]   = MOVE_ROCK_SLIDE,
    [BATTLE_ENVIRONMENT_CAVE_MONO]       = MOVE_SHADOW_BALL,
    [BATTLE_ENVIRONMENT_BUILDING_MONO]   = MOVE_SWIFT,
    [BATTLE_ENVIRONMENT_PLAIN_MONO]      = MOVE_SWIFT,
    [BATTLE_ENVIRONMENT_PLAIN]      = MOVE_SWIFT,
    [BATTLE_ENVIRONMENT_SNOW]       = MOVE_BLIZZARD,
#endif
    [BATTLE_ENVIRONMENT_UNDERWATER]       = MOVE_HYDRO_PUMP,
    [BATTLE_ENVIRONMENT_UNDERWATER_MONO]       = MOVE_HYDRO_PUMP,
...
{
    [BATTLE_ENVIRONMENT_GRASS]            = TYPE_NEW_NATURE,
    [BATTLE_ENVIRONMENT_LONG_GRASS]       = TYPE_NEW_NATURE,
    [BATTLE_ENVIRONMENT_SAND]             = TYPE_NEW_EARTH,
    [BATTLE_ENVIRONMENT_UNDERWATER]       = TYPE_NEW_WATER,
    [BATTLE_ENVIRONMENT_WATER]            = TYPE_NEW_WATER,
    [BATTLE_ENVIRONMENT_POND]             = TYPE_NEW_WATER,
    [BATTLE_ENVIRONMENT_CAVE]             = TYPE_NEW_EARTH,
    [BATTLE_ENVIRONMENT_BUILDING]         = TYPE_NEW_METAL,
    [BATTLE_ENVIRONMENT_BLANK_GBC]        = TYPE_NEW_DREAM,
    [BATTLE_ENVIRONMENT_GRASS_MONO]       = TYPE_NEW_NATURE,
    [BATTLE_ENVIRONMENT_LONG_GRASS_MONO]  = TYPE_NEW_NATURE,
    [BATTLE_ENVIRONMENT_SAND_MONO]        = TYPE_NEW_EARTH,
    [BATTLE_ENVIRONMENT_UNDERWATER_MONO]  = TYPE_NEW_WATER,
    [BATTLE_ENVIRONMENT_WATER_MONO]       = TYPE_NEW_WATER,
    [BATTLE_ENVIRONMENT_POND_MONO]        = TYPE_NEW_WATER,
    [BATTLE_ENVIRONMENT_CAVE_MONO]        = TYPE_NEW_EARTH,
    [BATTLE_ENVIRONMENT_BUILDING_MONO]    = TYPE_NEW_METAL,
    [BATTLE_ENVIRONMENT_SOARING]          = TYPE_NEW_FLYING,
    [BATTLE_ENVIRONMENT_SKY_PILLAR]       = TYPE_NEW_FLYING,
    [BATTLE_ENVIRONMENT_BURIAL_GROUND]    = TYPE_NEW_NETHER,
    [BATTLE_ENVIRONMENT_PUDDLE]           = TYPE_NEW_EARTH,
    [BATTLE_ENVIRONMENT_MARSH]            = TYPE_NEW_EARTH,
    [BATTLE_ENVIRONMENT_SWAMP]            = TYPE_NEW_EARTH,
    [BATTLE_ENVIRONMENT_SNOW]             = TYPE_NEW_ICE,
    [BATTLE_ENVIRONMENT_ICE]              = TYPE_NEW_ICE,
    [BATTLE_ENVIRONMENT_VOLCANO]          = TYPE_NEW_FIRE,
    [BATTLE_ENVIRONMENT_DISTORTION_WORLD] = TYPE_NEW_DARK,
    [BATTLE_ENVIRONMENT_SPACE]            = TYPE_NEW_DIVINE,
    [BATTLE_ENVIRONMENT_ULTRA_SPACE]      = TYPE_NEW_DIVINE,
    [BATTLE_ENVIRONMENT_MOUNTAIN]         = (B_CAMOUFLAGE_TYPES >= GEN_5 ? TYPE_NEW_EARTH : TYPE_NEW_EARTH),
    [BATTLE_ENVIRONMENT_MOUNTAIN_MONO]    = (B_CAMOUFLAGE_TYPES >= GEN_5 ? TYPE_NEW_EARTH : TYPE_NEW_EARTH),
    [BATTLE_ENVIRONMENT_PLAIN_MONO]       = (B_CAMOUFLAGE_TYPES >= GEN_4 ? TYPE_NEW_EARTH : TYPE_NEW_DREAM),
    [BATTLE_ENVIRONMENT_PLAIN]            = (B_CAMOUFLAGE_TYPES >= GEN_4 ? TYPE_NEW_EARTH : TYPE_NEW_DREAM),
};
...
bool32 IsMovePowderBlocked(u32 battlerAtk, u32 battlerDef, u32 move)
{
    ...
    if (IsPowderMove(move) && (battlerAtk != battlerDef))
    {
        if (B_POWDER_GRASS >= GEN_6
         && (IS_BATTLER_OF_TYPE(battlerDef, TYPE_NEW_NATURE) || GetBattlerAbility(battlerDef) == ABILITY_OVERCOAT))
        {
...
static void Cmd_attackcanceler(void)
{
    ...
    else if (isBounceable && !gBattleStruct->bouncedMoveIsUsed)
    {
        ...
        if (abilityDef == ABILITY_MAGIC_BOUNCE || abilityDef == ABILITY_FANTASY_BREAKER)
        {
    ...
    else if (gSpecialStatuses[gBattlerTarget].stormDrainRedirected)
    {
     ...
     && (effect != EFFECT_CURSE || IS_BATTLER_OF_TYPE(gBattlerAttacker, TYPE_NEW_NETHER))
     && (!gBattleMoveEffects[effect].twoTurnEffect || (gBattleMons[gBattlerAttacker].status2 & STATUS2_MULTIPLETURNS))
...
static bool32 AccuracyCalcHelper(u32 move, u32 battler)
{
    ...
    if ((gStatuses3[battler] & STATUS3_ALWAYS_HITS && gDisableStructs[battler].battlerWithSureHit == gBattlerAttacker)
     || (B_TOXIC_NEVER_MISS >= GEN_6 && moveEffect == EFFECT_TOXIC && IS_BATTLER_OF_TYPE(gBattlerAttacker, TYPE_NEW_MIASMA))
...
u32 GetTotalAccuracy(u32 battlerAtk, u32 battlerDef, u32 move, u32 atkAbility, u32 defAbility, u32 atkHoldEffect, u32 defHoldEffect)
{
    ...
    case ABILITY_PURE_WHITE:
        if (gBattleMons[battlerDef].status2 & STATUS2_CONFUSION)
            calc = (calc * 50) / 100; // 1.5 pure white loss
        break;
    }
