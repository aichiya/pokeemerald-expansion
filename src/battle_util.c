...
{//                   Defender -->
 //  Attacker         Normal  Fighting Flying  Poison  Ground   Rock    Bug     Ghost   Steel  Mystery  Fire   Water   Grass  Electric Psychic   Ice   Dragon   Dark   Fairy
    [TYPE_NORMAL]   = {______, X(0.5), ______, ______, ______, ______, ______, X(0.0), ______, ______, ______, ______, ______, ______, ______, ______, ______, X(0.5), ______},
    [TYPE_FIGHTING] = {X(2.0), X(0.5), X(0.5), ______, ______, ______, X(2.0), ______, X(2.0), ______, ______, ______, ______, ______, X(0.5), X(2.0), ______, ______, ______},
    [TYPE_FLYING]   = {______, X(2.0), ______, ______, ______, X(2.0), ______, ______, X(0.5), ______, ______, ______, X(2.0), X(0.5), ______, ______, ______, ______, X(0.5)},
    [TYPE_POISON]   = {______, ______, ______, X(0.5), X(0.5), ______, ______, X(0.5), X(0.0), ______, ______, X(2.0), X(2.0), ______, X(0.5), ______, ______, ______, ______},
    [TYPE_GROUND]   = {______, ______, X(0.0), X(2.0), ______, X(0.5), ______, ______, X(2.0), ______, X(2.0), ______, X(0.5), ______, ______, ______, ______, ______, X(2.0)},
    [TYPE_ROCK]     = {______, ______, X(0.5), ______, ______, ______, ______, X(2.0), ______, ______, ______, ______, X(0.5), ______, ______, ______, X(2.0), ______, ______},
    [TYPE_BUG]      = {______, X(0.5), ______, X(0.5), ______, ______, X(0.5), ______, ______, ______, ______, ______, ______, ______, X(2.0), ______, X(0.5), X(2.0), ______},
    ...
    [TYPE_GHOST]    = {X(0.0), ______, ______, ______, ______, X(0.5), X(0.5), X(2.0), ______, ______, ______, ______, ______, ______, X(2.0), ______, ______, X(0.0), ______},
#endif
    [TYPE_STEEL]    = {______, ______, ______, ______, ______, ______, ______, ______, X(0.5), ______, X(0.5), X(0.5), ______, ______, ______, X(2.0), ______, X(2.0), X(0.5)},
    ...
    [TYPE_FIRE]     = {______, ______, ______, ______, X(0.5), X(2.0), ______, ______, X(2.0), ______, X(0.5), X(0.5), X(2.0), X(0.5), ______, X(2.0), X(0.5), ______, ______},
    ...
    [TYPE_GRASS]    = {______, ______, X(0.5), X(0.5), X(2.0), X(0.5), ______, ______, ______, ______, X(0.5), X(2.0), X(0.5), X(2.0), ______, ______, ______, ______, ______},
    [TYPE_ELECTRIC] = {______, X(0.5), X(2.0), X(2.0), ______, ______, ______, ______, X(0.5), ______, X(2.0), ______, X(0.5), X(0.5), ______, ______, ______, ______, ______},
    [TYPE_PSYCHIC]  = {______, X(2.0), ______, X(2.0), ______, ______, X(0.5), X(0.5), ______, ______, ______, ______, ______, ______, X(0.5), ______, X(2.0), X(0.5), ______},
    [TYPE_ICE]      = {______, ______, X(2.0), ______, X(2.0), ______, ______, ______, X(0.5), ______, X(0.5), X(0.5), X(2.0), X(2.0), ______, X(0.5), ______, ______, ______},
    [TYPE_DRAGON]   = {______, ______, ______, X(0.5), ______, ______, X(2.0), ______, ______, ______, ______, ______, ______, ______, X(0.5), ______, ______, X(2.0), ______},
#if B_STEEL_RESISTANCES >= GEN_6
    [TYPE_DARK]     = {______, X(2.0), ______, X(0.5), ______, ______, X(0.5), X(0.0), ______, ______, ______, ______, ______, ______, X(2.0), ______, ______, X(0.5), ______},
#else
    [TYPE_DARK]     = {______, X(2.0), ______, X(0.5), ______, ______, X(0.5), X(0.0), ______, ______, ______, ______, ______, ______, X(2.0), ______, ______, X(0.5), ______},
#endif
    [TYPE_FAIRY]    = {______, ______, X(2.0), ______, ______, ______, ______, ______, ______, ______, ______, X(2.0), X(0.5), ______, ______, ______, X(0.5), ______, X(0.5)},
};
