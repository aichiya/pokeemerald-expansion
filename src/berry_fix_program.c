...
static const u8 sText_BerryProgramWillBeUpdatedPressA[] = _("The Berry Program on your Fragmon\n"
...
static const u8 sText_TurnOffPowerHoldingStartSelect[] = _("Please turn on the power of Fragmon\n"
