const struct AbilityInfo gAbilitiesInfo[ABILITIES_COUNT] =
{
    ...
    [ABILITY_SWARM] =
    {
        ...
        .description = COMPOUND_STRING("Ups Beast moves at low HP."),
        .aiRating = 5,
    },
    ...
    {
        .name = _("Divine Aura"),
        .description = COMPOUND_STRING("Ups all Divine-type moves."),
        .aiRating = 6,
        .breakable = B_UPDATED_ABILITY_DATA < GEN_8,
    },
    ...
    [ABILITY_ROCKY_PAYLOAD] =
    {
        ...
        .description = COMPOUND_STRING("Powers up Earth-type moves."),
        .aiRating = 6,
    },
    ...
    {
        .name = _("Earth Eater"),
        .description = COMPOUND_STRING("Restores if hit by Earth."),
        .aiRating = 7,
        .breakable = TRUE,
    },
