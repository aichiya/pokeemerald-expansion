...
const u32 gBattleEnvironmentTiles_BlankGBC[] = INCBIN_U32("graphics/battle_terrain/blank/tiles.4bpp.lz");
const u16 gBattleEnvironmentPalette_BlankGBC[] = INCBIN_U16("graphics/battle_terrain/blank/palette.gbapal");
const u32 gBattleEnvironmentTilemap_BlankGBC[] = INCBIN_U32("graphics/battle_terrain/blank/map.bin.lz");
const u32 gBattleEnvironmentAnimTiles_BlankGBC[] = INCBIN_U32("graphics/battle_terrain/blank/anim_tiles.4bpp.lz");
const u32 gBattleEnvironmentAnimTilemap_BlankGBC[] = INCBIN_U32("graphics/battle_terrain/blank/anim_map.bin.lz");
