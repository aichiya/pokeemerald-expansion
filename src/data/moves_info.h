...
//        .mirrorMoveBanned = TRUE,
    ...
    [MOVE_HAPPY_HOUR] =  // Edited effect
    {
        ...
        .effect = EFFECT_DO_NOTHING,  // to do acc up
        .power = 0,
        .type = TYPE_NEW_HEART,
        .accuracy = 0,
        .pp = 30,
