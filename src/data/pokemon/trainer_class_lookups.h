...
const u16 gTrainerPicToTrainerBackPic[] =
{
    ...
    [TRAINER_BACK_PIC_TH_RENKO_BIG] = TRAINER_PIC_TH_RENKO_BIG,
    [TRAINER_BACK_PIC_TH_MARIBEL_BIG] = TRAINER_PIC_TH_MARIBEL_BIG,
    [TRAINER_BACK_PIC_TH_RENKO_SMALL] = TRAINER_PIC_TH_RENKO_SMALL,
    [TRAINER_BACK_PIC_TH_MARIBEL_SMALL] = TRAINER_PIC_TH_MARIBEL_SMALL,
    [TRAINER_BACK_PIC_TH_RENKO_CLASSIC] = TRAINER_PIC_TH_RENKO_CLASSIC,
    [TRAINER_BACK_PIC_TH_MARIBEL_CLASSIC] = TRAINER_PIC_TH_MARIBEL_CLASSIC,
    [TRAINER_BACK_PIC_TH_REIMU] = TRAINER_PIC_TH_REIMU,
    [TRAINER_BACK_PIC_TH_MARISA] = TRAINER_PIC_TH_MARISA,
};
