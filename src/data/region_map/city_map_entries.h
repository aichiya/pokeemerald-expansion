...
{
    {
        .mapSecId = MAPSEC_JOHTO_TWINRIVER_CITY,
        .index = 0,
        .tilemap = gPokenavCityMap_Littleroot_0,
    },
    {
        .mapSecId = MAPSEC_JOHTO_NEW_BARK_TOWN,
        .index = 0,
        .tilemap = gPokenavCityMap_Oldale_0,
    },
    {
        .mapSecId = MAPSEC_JOHTO_CHERRYGROVE_CITY,
        .index = 0,
        .tilemap = gPokenavCityMap_Dewford_0,
    },
    {
        .mapSecId = MAPSEC_JOHTO_VIOLET_CITY,
        .index = 0,
        .tilemap = gPokenavCityMap_Lavaridge_0,
    },
    {
        .mapSecId = MAPSEC_JOHTO_AZALEA_TOWN,
        .index = 0,
        .tilemap = gPokenavCityMap_Fallarbor_0,
    },
    {
        .mapSecId = MAPSEC_JOHTO_CIANWOOD_CITY,
        .index = 0,
        .tilemap = gPokenavCityMap_Verdanturf_0,
    },
    {
        .mapSecId = MAPSEC_JOHTO_GOLDENROD_CITY,
        .index = 0,
        .tilemap = gPokenavCityMap_Pacifidlog_0,
    },
    {
        .mapSecId = MAPSEC_JOHTO_OLIVINE_CITY,
        .index = 0,
        .tilemap = gPokenavCityMap_Petalburg_0,
    },
    {
        .mapSecId = MAPSEC_JOHTO_ECRUTEAK_CITY,
        .index = 0,
    ...
    {
        .mapSecId = MAPSEC_JOHTO_MAHOGANY_TOWN,
        .index = 0,
    ...
    {
        .mapSecId = MAPSEC_JOHTO_LAKE_OF_RAGE,
        .index = 0,
    ...
    {
        .mapSecId = MAPSEC_JOHTO_BLACKTHORN_CITY,
        .index = 0,
        .tilemap = gPokenavCityMap_Fortree_0,
    },
    {
        .mapSecId = MAPSEC_JOHTO_MT_SILVER,
        .index = 0,
    ...
    {
        .mapSecId = MAPSEC_JOHTO_INDIGO_PLATEAU,
        .index = 0,
    ...
    {
        .mapSecId = MAPSEC_JOHTO_MORIYA_SHRINE,
        .index = 0,
