...
const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_FALSE_SWIPE] = _("Blade Flash"),
    ...
    [MOVE_LUSTER_PURGE] = _("Musou Tensei"),
    ...
    [MOVE_SHADOW_FORCE] = _("Shadow Dive"),
...
static const u8 sText_Light_That_Burns_The_Sky[] = _("Gensokyo Ends with Me");
