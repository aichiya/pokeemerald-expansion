...
const u16 gMetatiles_GeneralGS[] = INCBIN_U16("data/tilesets/primary/general_gs/metatiles.bin");
const u16 gMetatileAttributes_GeneralGS[] = INCBIN_U16("data/tilesets/primary/general_gs/metatile_attributes.bin");
