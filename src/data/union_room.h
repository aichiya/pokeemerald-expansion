...
ALIGNED(4) static const u8 sText_BattleDeclinedMale[] = _("Sorry! My Fragmon don't seem to\nbe feeling too well right now.\lLet me battle you another time.\p");
ALIGNED(4) static const u8 sText_BattleDeclinedFemale[] = _("I'm terribly sorry, but my Fragmon\naren't feeling well…\pLet's battle another time.\p");
...
ALIGNED(4) static const u8 sText_SwitchedMonsMale[] = _("Oh! How could you use that\nFragmon in that situation?\p");
ALIGNED(4) static const u8 sText_YoureToughFemale[] = _("That Fragmon…\nIt's been raised really well!\p");
...
ALIGNED(4) static const u8 sText_MaleTraded1[] = _("Yeahah!\nI really wanted this Fragmon!\p");
ALIGNED(4) static const u8 sText_MaleTraded2[] = _("Finally, a trade got me that\nFragmon I'd wanted a long time.\p");
ALIGNED(4) static const u8 sText_FemaleTraded1[] = _("I'm trading Fragmon right now.\p");
ALIGNED(4) static const u8 sText_FemaleTraded2[] = _("I finally got that Fragmon I\nwanted in a trade!\p");
...
ALIGNED(4) static const u8 sText_RegisterMonAtTradingBoard[] = _("Welcome to the TRADING BOARD.\pYou may register your Fragmon\nand offer it up for a trade.\pWould you like to register one of\nyour Fragmon?");
ALIGNED(4) static const u8 sText_TradingBoardInfo[] = _("This TRADING BOARD is used for\n"
                                                        "offering a Fragmon for a trade.\p"
                                                        "All you need to do is register a\n"
                                                        "Fragmon for a trade.\p"
                                                        "Another TRAINER may offer a party\n"
                                                        "Fragmon in return for the trade.\p"
                                                        "We hope you will register Fragmon\n"
                                                        "and trade them with many, many\l"
                                                        "other TRAINERS.\p"
                                                        "Would you like to register one of\nyour Fragmon?");
ALIGNED(4) static const u8 sText_ThankYouForRegistering[] = _("We have registered your Fragmon for\ntrade on the TRADING BOARD.\pThank you for using this service!\p"); // unused
ALIGNED(4) static const u8 sText_NobodyHasRegistered[] = _("Nobody has registered any Fragmon\nfor trade on the TRADING BOARD.\p\n"); // unused
ALIGNED(4) static const u8 sText_ChooseRequestedMonType[] = _("Please choose the type of Fragmon\nthat you would like in the trade.\n");
ALIGNED(4) static const u8 sText_WhichMonWillYouOffer[] = _("Which of your party Fragmon will\nyou offer in trade?\p");
...
ALIGNED(4) static const u8 sText_ChooseLeaderPokemonJump[] = _("Jump with mini Fragmon!\nPlease choose the LEADER.");
...
ALIGNED(4) static const u8 sText_PokemonTrades[] = _("Fragmon TRADES");
...
ALIGNED(4) static const u8 sText_PokemonJump[] = _("Fragmon JUMP");
