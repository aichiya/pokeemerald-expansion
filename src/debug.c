    ...
    switch (id)
    {
        ...
        case DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_LOCATIONS:
            result = FlagGet(FLAG_VISITED_LITTLEROOT_TOWN) &&
                ...
                FlagGet(FLAG_VISITED_GENSOKYO_HAKUREI_SHRINE) &&
                FlagGet(FLAG_VISITED_GENSOKYO_HUMAN_VILLAGE) &&
                FlagGet(FLAG_VISITED_GENSOKYO_KOURINDOU) &&
                FlagGet(FLAG_VISITED_GENSOKYO_MUENZUKA) &&
                FlagGet(FLAG_VISITED_GENSOKYO_HAKUGYOKUROU) &&
                FlagGet(FLAG_VISITED_GENSOKYO_MORIYA_SHRINE) &&
                FlagGet(FLAG_VISITED_GENSOKYO_SCARLET_DEVIL_MANSION) &&
                FlagGet(FLAG_VISITED_GENSOKYO_CHIREIDEN) &&
                ...
                FlagGet(FLAG_VISITED_GENSOKYO_LUNAR_CAPITAL) &&
                FlagGet(FLAG_VISITED_GENSOKYO_FANTASY_LEAGUE) &&
                FlagGet(FLAG_VISITED_YYYI_SEA_OF_TREES1) &&
                FlagGet(FLAG_VISITED_YYYI_SEA_OF_FLAME1) &&
                FlagGet(FLAG_VISITED_KEY_ILLUSIONARY_WORLD1) &&
                FlagGet(FLAG_VISITED_JAVA_YOGYAKARTA) &&
                FlagGet(FLAG_VISITED_JAVA_SOLO) &&
...
static void DebugAction_FlagsVars_ToggleFlyFlags(u8 taskId)
{
    if (FlagGet(FLAG_LANDMARK_BATTLE_FRONTIER))
    {
        ...
        FlagClear(FLAG_VISITED_GENSOKYO_HAKUREI_SHRINE);
        FlagClear(FLAG_VISITED_GENSOKYO_HUMAN_VILLAGE);
        FlagClear(FLAG_VISITED_GENSOKYO_KOURINDOU);
        FlagClear(FLAG_VISITED_GENSOKYO_MUENZUKA);
        FlagClear(FLAG_VISITED_GENSOKYO_HAKUGYOKUROU);
        FlagClear(FLAG_VISITED_GENSOKYO_MORIYA_SHRINE);
        FlagClear(FLAG_VISITED_GENSOKYO_SCARLET_DEVIL_MANSION);
        FlagClear(FLAG_VISITED_GENSOKYO_CHIREIDEN);
        ...
        FlagClear(FLAG_VISITED_GENSOKYO_LUNAR_CAPITAL);
        FlagClear(FLAG_VISITED_GENSOKYO_FANTASY_LEAGUE);
        FlagClear(FLAG_VISITED_YYYI_SEA_OF_TREES1);
        FlagClear(FLAG_VISITED_YYYI_SEA_OF_FLAME1);
        FlagClear(FLAG_VISITED_KEY_ILLUSIONARY_WORLD1);
        FlagClear(FLAG_VISITED_JAVA_YOGYAKARTA);
        FlagClear(FLAG_VISITED_JAVA_SOLO);
    ...
    else
    {
        ...
        FlagSet(FLAG_VISITED_GENSOKYO_HAKUREI_SHRINE);
        FlagSet(FLAG_VISITED_GENSOKYO_HUMAN_VILLAGE);
        FlagSet(FLAG_VISITED_GENSOKYO_KOURINDOU);
        FlagSet(FLAG_VISITED_GENSOKYO_MUENZUKA);
        FlagSet(FLAG_VISITED_GENSOKYO_HAKUGYOKUROU);
        FlagSet(FLAG_VISITED_GENSOKYO_MORIYA_SHRINE);
        FlagSet(FLAG_VISITED_GENSOKYO_SCARLET_DEVIL_MANSION);
        FlagSet(FLAG_VISITED_GENSOKYO_CHIREIDEN);
        ...
        FlagSet(FLAG_VISITED_GENSOKYO_LUNAR_CAPITAL);
        FlagSet(FLAG_VISITED_GENSOKYO_FANTASY_LEAGUE);
        FlagSet(FLAG_VISITED_YYYI_SEA_OF_TREES1);
        FlagSet(FLAG_VISITED_YYYI_SEA_OF_FLAME1);
        FlagSet(FLAG_VISITED_KEY_ILLUSIONARY_WORLD1);
        FlagSet(FLAG_VISITED_JAVA_YOGYAKARTA);
        FlagSet(FLAG_VISITED_JAVA_SOLO);
...
#define SOUND_LIST_BGM \
    ...
    X(INS_TEST_FULL_N01_W01) \
    X(INS_TEST_FULL_N04_W04) \
    X(INS_TEST_FULL_N08_W08) \
    X(INS_TEST_FULL_N16_W16) \
    X(INS_TEST_FULL_N24_W24) \
    X(INS_TEST_FULL_N48_W48) \
    X(INS_TEST_FULL_N96_W96) \
    X(INS_TEST_FULL_TIE) \
    X(INS_TEST_OCT_M2_N01_W01) \
    X(INS_TEST_OCT_M2_N04_W04) \
    X(INS_TEST_OCT_M2_N08_W08) \
    X(INS_TEST_OCT_M2_N16_W16) \
    X(INS_TEST_OCT_M2_N24_W24) \
    X(INS_TEST_OCT_M2_N48_W48) \
    X(INS_TEST_OCT_M2_N96_W96) \
    X(INS_TEST_OCT_M2_TIE) \
    X(INS_TEST_OCT_M1_N01_W01) \
    X(INS_TEST_OCT_M1_N04_W04) \
    X(INS_TEST_OCT_M1_N08_W08) \
    X(INS_TEST_OCT_M1_N16_W16) \
    X(INS_TEST_OCT_M1_N24_W24) \
    X(INS_TEST_OCT_M1_N48_W48) \
    X(INS_TEST_OCT_M1_N96_W96) \
    X(INS_TEST_OCT_M1_TIE) \
    X(INS_TEST_OCT_0_N01_W01) \
    X(INS_TEST_OCT_0_N04_W04) \
    X(INS_TEST_OCT_0_N08_W08) \
    X(INS_TEST_OCT_0_N16_W16) \
    X(INS_TEST_OCT_0_N24_W24) \
    X(INS_TEST_OCT_0_N48_W48) \
    X(INS_TEST_OCT_0_N96_W96) \
    X(INS_TEST_OCT_0_TIE) \
    X(INS_TEST_OCT_1_N01_W01) \
    X(INS_TEST_OCT_1_N04_W04) \
    X(INS_TEST_OCT_1_N08_W08) \
    X(INS_TEST_OCT_1_N16_W16) \
    X(INS_TEST_OCT_1_N24_W24) \
    X(INS_TEST_OCT_1_N48_W48) \
    X(INS_TEST_OCT_1_N96_W96) \
    X(INS_TEST_OCT_1_TIE) \
    X(INS_TEST_OCT_2_N01_W01) \
    X(INS_TEST_OCT_2_N04_W04) \
    X(INS_TEST_OCT_2_N08_W08) \
    X(INS_TEST_OCT_2_N16_W16) \
    X(INS_TEST_OCT_2_N24_W24) \
    X(INS_TEST_OCT_2_N48_W48) \
    X(INS_TEST_OCT_2_N96_W96) \
    X(INS_TEST_OCT_2_TIE) \
    X(INS_TEST_OCT_3_N01_W01) \
    X(INS_TEST_OCT_3_N04_W04) \
    X(INS_TEST_OCT_3_N08_W08) \
    X(INS_TEST_OCT_3_N16_W16) \
    X(INS_TEST_OCT_3_N24_W24) \
    X(INS_TEST_OCT_3_N48_W48) \
    X(INS_TEST_OCT_3_N96_W96) \
    X(INS_TEST_OCT_3_TIE) \
    X(INS_TEST_OCT_4_N01_W01) \
    X(INS_TEST_OCT_4_N04_W04) \
    X(INS_TEST_OCT_4_N08_W08) \
    X(INS_TEST_OCT_4_N16_W16) \
    X(INS_TEST_OCT_4_N24_W24) \
    X(INS_TEST_OCT_4_N48_W48) \
    X(INS_TEST_OCT_4_N96_W96) \
    X(INS_TEST_OCT_4_TIE) \
    X(INS_TEST_OCT_5_N01_W01) \
    X(INS_TEST_OCT_5_N04_W04) \
    X(INS_TEST_OCT_5_N08_W08) \
    X(INS_TEST_OCT_5_N16_W16) \
    X(INS_TEST_OCT_5_N24_W24) \
    X(INS_TEST_OCT_5_N48_W48) \
    X(INS_TEST_OCT_5_N96_W96) \
    X(INS_TEST_OCT_5_TIE) \
    X(INS_TEST_OCT_6_N01_W01) \
    X(INS_TEST_OCT_6_N04_W04) \
    X(INS_TEST_OCT_6_N08_W08) \
    X(INS_TEST_OCT_6_N16_W16) \
    X(INS_TEST_OCT_6_N24_W24) \
    X(INS_TEST_OCT_6_N48_W48) \
    X(INS_TEST_OCT_6_N96_W96) \
    X(INS_TEST_OCT_6_TIE) \
    X(INS_TEST_OCT_7_N01_W01) \
    X(INS_TEST_OCT_7_N04_W04) \
    X(INS_TEST_OCT_7_N08_W08) \
    X(INS_TEST_OCT_7_N16_W16) \
    X(INS_TEST_OCT_7_N24_W24) \
    X(INS_TEST_OCT_7_N48_W48) \
    X(INS_TEST_OCT_7_N96_W96) \
    X(INS_TEST_OCT_7_TIE) \
    X(INS_TEST_OCT_8_N01_W01) \
    X(INS_TEST_OCT_8_N04_W04) \
    X(INS_TEST_OCT_8_N08_W08) \
    X(INS_TEST_OCT_8_N16_W16) \
    X(INS_TEST_OCT_8_N24_W24) \
    X(INS_TEST_OCT_8_N48_W48) \
    X(INS_TEST_OCT_8_N96_W96) \
    X(INS_TEST_OCT_8_TIE) \
    X(INS_TEST_PLACEHOLDER_1) \
    X(INS_TEST_PLACEHOLDER_2) \
    X(INS_TEST_PLACEHOLDER_3) \
    X(INS_TEST_PLACEHOLDER_4) \
    X(INS_TEST_PLACEHOLDER_5) \
    X(INS_TEST_PLACEHOLDER_6) \
    X(INS_TEST_PLACEHOLDER_7) \
