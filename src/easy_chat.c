...
static const u16 sBerryMasterWifePhrases[][2] = {
    ...
    [PHRASE_OVERWHELMING_LATIAS - 1] = {EC_WORD_OVERWHELMING, EC_POKEMON(NIDOQUEEN)}, // {EC_WORD_OVERWHELMING, EC_POKEMON(LATIAS)},
    [PHRASE_COOL_LATIOS - 1]         = {EC_WORD_COOL, EC_POKEMON(NIDOKING)}, // {EC_WORD_COOL, EC_POKEMON(LATIOS)},
