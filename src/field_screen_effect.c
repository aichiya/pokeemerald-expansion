...
static const u8 sText_PlayerScurriedToCenter[] = _("{PLAYER} scurried to a Fragmon CENTER,\nprotecting the exhausted and fainted\nFragmon from further harm…\p");
...
static const u8 sText_PlayerRegroupCenter[] = _("{PLAYER} scurried to a Fragmon CENTER,\nto regroup and reconsider the battle\nstrategy…\p");
