...
{
    return CopyMonFavoritePokeblockName(GetNature(&gPlayerParty[GetLeadMonIndex()], TRUE), gStringVar1); //    return CopyMonFavoritePokeblockName(GetNature(&gPlayerParty[GetLeadMonIndex()]), gStringVar1);
}
...
void ShowNatureGirlMessage(void)
{
    ...
    nature = GetNature(&gPlayerParty[gSpecialVar_0x8004], TRUE); //    nature = GetNature(&gPlayerParty[gSpecialVar_0x8004]);
