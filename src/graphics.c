...
const u32 gBattleAnimSpriteGfx_ClassicIceCrystals[] = INCGFX_U32("graphics/battle_anims/sprites/classic_ice_crystals.4bpp", ".smol");
const u16 gBattleAnimSpritePal_ClassicIceCrystals[] = INCGFX_U16("graphics/battle_anims/sprites/classic_ice_crystals.pal", ".gbapal");
const u32 gBattleAnimSpriteGfx_ClassicAbsorb[] = INCGFX_U32("graphics/battle_anims/sprites/classic_absorb.png", ".4bpp.smol");
const u16 gBattleAnimSpritePal_ClassicAbsorb[] = INCGFX_U16("graphics/battle_anims/sprites/classic_absorb.png", ".gbapal");
const u32 gBattleAnimSpriteGfx_ClassicWaterColumn[] = INCGFX_U32("graphics/battle_anims/sprites/classic_water_column.png", ".4bpp.smol");
const u16 gBattleAnimSpritePal_ClassicWaterColumn[] = INCGFX_U16("graphics/battle_anims/sprites/classic_water_column.png", ".gbapal");
const u32 gBattleAnimSpriteGfx_ClassicGust[] = INCGFX_U32("graphics/battle_anims/sprites/classic_gust.png", ".4bpp.smol");
const u16 gBattleAnimSpritePal_ClassicGust[] = INCGFX_U16("graphics/battle_anims/sprites/classic_gust.png", ".gbapal");
const u32 gBattleAnimSpriteGfx_ClassicLightWall[] = INCGFX_U32("graphics/battle_anims/sprites/classic_light_wall.png", ".4bpp.smol");
const u16 gBattleAnimSpritePal_ClassicLightWall[] = INCGFX_U16("graphics/battle_anims/sprites/classic_light_wall.png", ".gbapal");
const u32 gBattleAnimSpriteGfx_ClassicSword2[] = INCGFX_U32("graphics/battle_anims/sprites/classic_sword_2.png", ".4bpp.smol");
const u16 gBattleAnimSpritePal_ClassicSword2[] = INCGFX_U16("graphics/battle_anims/sprites/classic_sword_2.png", ".gbapal");
const u32 gBattleAnimSpriteGfx_ClassicCut[] = INCGFX_U32("graphics/battle_anims/sprites/classic_cut.png", ".4bpp.smol");
const u16 gBattleAnimSpritePal_ClassicCut[] = INCGFX_U16("graphics/battle_anims/sprites/classic_cut.png", ".gbapal");
const u32 gBattleAnimSpriteGfx_ClassicRocks[] = INCGFX_U32("graphics/battle_anims/sprites/classic_rocks.png", ".4bpp.smol");
const u16 gBattleAnimSpritePal_ClassicRocks[] = INCGFX_U16("graphics/battle_anims/sprites/classic_rocks.png", ".gbapal");
const u32 gBattleAnimBgImage_ClassicMist[] = INCGFX_U32("graphics/battle_anims/backgrounds/classic_mist.png", ".4bpp.smol");
const u16 gBattleAnimBgPalette_ClassicMist[] = INCGFX_U16("graphics/battle_anims/backgrounds/classic_mist.png", ".gbapal");
