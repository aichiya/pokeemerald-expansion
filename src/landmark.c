...
static const struct LandmarkList sLandmarkLists[] =
{
    ...
    {MAPSEC_GENSOKYO_NAMELESS_HILL, 0, Landmarks_Route112_0},
    {MAPSEC_GENSOKYO_NAMELESS_HILL, 1, Landmarks_Route112_1},
    ...
    {MAPSEC_GENSOKYO_MUGENKAN, 0, Landmarks_MeteorFalls},
    {MAPSEC_GENSOKYO_MUGENKAN, 1, Landmarks_MeteorFalls},
