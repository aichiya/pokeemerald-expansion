...
static const u8 gText_ContinueMenuPokedex[] = _("NC{EMOJI_IRRITATED}PDA");
...
static void Task_NewGameBirchSpeechSub_InitPokeBall(u8 taskId)
{
    ...
    CreatePokeballSpriteToReleaseMon(spriteId, gSprites[spriteId].oam.paletteNum, 112, 58, 0, 0, 32, PALETTES_BG, SPECIES_EGG);
...
{
    return CreateMonPicSprite_Affine(SPECIES_EGG, FALSE, 0, MON_PIC_AFFINE_FRONT, x, y, 14, TAG_NONE);
}
