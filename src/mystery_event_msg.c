...
const u8 gText_MysteryEventNationalDex[] = _("The NC{EMOJI_IRRITATED}PDA has been upgraded\nwith the Isekai Mode.");
...
const u8 gText_MysteryEventNewTrainer[] = _("A new trainer has arrived\nsomewhere.");
