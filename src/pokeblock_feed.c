...
static void Task_PrintAtePokeblockMessage(u8 taskId)
{
    ...
    gPokeblockGain = PokeblockGetGain(GetNature(mon, TRUE), pokeblock); //    gPokeblockGain = PokeblockGetGain(GetNature(mon), pokeblock);
...
static u8 CreateMonSprite(struct Pokemon *mon)
{
    ...
    sPokeblockFeed->nature = GetNature(mon, TRUE); //    sPokeblockFeed->nature = GetNature(mon);
