...
static inline bool32 ShouldShowMoveRelearner(void)
{
    return (P_SUMMARY_SCREEN_MOVE_RELEARNER
         ...
         && !(gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(DEWFORD_TOWN_GYM) && gSaveBlock1Ptr->location.mapNum == MAP_NUM(DEWFORD_TOWN_GYM))
         && !(gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(LAVARIDGE_TOWN_GYM_1F) && gSaveBlock1Ptr->location.mapNum == MAP_NUM(LAVARIDGE_TOWN_GYM_1F))
         && !(gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(LAVARIDGE_TOWN_GYM_B1F) && gSaveBlock1Ptr->location.mapNum == MAP_NUM(LAVARIDGE_TOWN_GYM_B1F))
         && !(gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(PETALBURG_CITY_GYM) && gSaveBlock1Ptr->location.mapNum == MAP_NUM(PETALBURG_CITY_GYM))
         && !(gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(MAUVILLE_CITY_GYM) && gSaveBlock1Ptr->location.mapNum == MAP_NUM(MAUVILLE_CITY_GYM))
         && !(gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(RUSTBORO_CITY_GYM) && gSaveBlock1Ptr->location.mapNum == MAP_NUM(RUSTBORO_CITY_GYM))
         && !(gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(FORTREE_CITY_GYM) && gSaveBlock1Ptr->location.mapNum == MAP_NUM(FORTREE_CITY_GYM))
         && !(gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(MOSSDEEP_CITY_GYM) && gSaveBlock1Ptr->location.mapNum == MAP_NUM(MOSSDEEP_CITY_GYM))
         && !(gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(SOOTOPOLIS_CITY_GYM_1F) && gSaveBlock1Ptr->location.mapNum == MAP_NUM(SOOTOPOLIS_CITY_GYM_1F))
         && !(gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(SOOTOPOLIS_CITY_GYM_B1F) && gSaveBlock1Ptr->location.mapNum == MAP_NUM(SOOTOPOLIS_CITY_GYM_B1F))
         && !(gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(EVER_GRANDE_CITY_SIDNEYS_ROOM) && gSaveBlock1Ptr->location.mapNum == MAP_NUM(EVER_GRANDE_CITY_SIDNEYS_ROOM))
         && !(gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(EVER_GRANDE_CITY_PHOEBES_ROOM) && gSaveBlock1Ptr->location.mapNum == MAP_NUM(EVER_GRANDE_CITY_PHOEBES_ROOM))
         && !(gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(EVER_GRANDE_CITY_GLACIAS_ROOM) && gSaveBlock1Ptr->location.mapNum == MAP_NUM(EVER_GRANDE_CITY_GLACIAS_ROOM))
         && !(gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(EVER_GRANDE_CITY_DRAKES_ROOM) && gSaveBlock1Ptr->location.mapNum == MAP_NUM(EVER_GRANDE_CITY_DRAKES_ROOM))
         && !(gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(EVER_GRANDE_CITY_CHAMPIONS_ROOM) && gSaveBlock1Ptr->location.mapNum == MAP_NUM(EVER_GRANDE_CITY_CHAMPIONS_ROOM))
         && !(gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(EVER_GRANDE_CITY_HALL1) && gSaveBlock1Ptr->location.mapNum == MAP_NUM(EVER_GRANDE_CITY_HALL1))
         && !(gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(EVER_GRANDE_CITY_HALL2) && gSaveBlock1Ptr->location.mapNum == MAP_NUM(EVER_GRANDE_CITY_HALL2))
         && !(gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(EVER_GRANDE_CITY_HALL3) && gSaveBlock1Ptr->location.mapNum == MAP_NUM(EVER_GRANDE_CITY_HALL3))
         && !(gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(EVER_GRANDE_CITY_HALL4) && gSaveBlock1Ptr->location.mapNum == MAP_NUM(EVER_GRANDE_CITY_HALL4))
         && !(gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(EVER_GRANDE_CITY_HALL5) && gSaveBlock1Ptr->location.mapNum == MAP_NUM(EVER_GRANDE_CITY_HALL5)));
}
