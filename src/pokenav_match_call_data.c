...
{
    .type = MC_TYPE_NPC,
    .mapSec = MAPSEC_REV_JOHTO_LAKE_OF_RAGE,
    .flag = 0xFFFF,
...
{
    .type = MC_TYPE_LEADER,
    .mapSec = MAPSEC_REV_JOHTO_OLIVINE_CITY,
...
{
    .type = MC_TYPE_NPC,
    .mapSec = MAPSEC_REV_JOHTO_TWINRIVER_CITY,
...
static const struct MatchCallLocationOverride sWallyLocationData[] = {
    { FLAG_HIDE_MAUVILLE_CITY_WALLY,          MAPSEC_REV_JOHTO_CIANWOOD_CITY },
    { FLAG_GROUDON_AWAKENED_MAGMA_HIDEOUT,    MAPSEC_NONE },
    { FLAG_HIDE_VICTORY_ROAD_ENTRANCE_WALLY,  MAPSEC_REV_JOHTO_ROUTE_44 },
    { 0xFFFF,                                 MAPSEC_NONE }
};
...
{
    .type = MC_TYPE_LEADER,
    .mapSec = MAPSEC_REV_JOHTO_CHERRYGROVE_CITY,
...
{
    .type = MC_TYPE_LEADER,
    .mapSec = MAPSEC_REV_JOHTO_MAHOGANY_TOWN,
...
{
    .type = MC_TYPE_LEADER,
    .mapSec = MAPSEC_REV_JOHTO_VIOLET_CITY,
...
{
    .type = MC_TYPE_LEADER,
    .mapSec = MAPSEC_REV_JOHTO_BLACKTHORN_CITY,
...
{
    .type = MC_TYPE_LEADER,
    .mapSec = MAPSEC_REV_JOHTO_INDIGO_PLATEAU,
...
{
    .type = MC_TYPE_LEADER,
    .mapSec = MAPSEC_REV_JOHTO_MORIYA_SHRINE,
...
{
    .type = MC_TYPE_LEADER,
    .mapSec = MAPSEC_REV_JOHTO_SPACE_HYPER_VESSEL,
