...
static const u8 *const sPageDescriptions[] =
{
    ...
    [POKENAV_MENUITEM_CONDITION]               = COMPOUND_STRING("Check Fragmon in detail."),
    ...
    [POKENAV_MENUITEM_SWITCH_OFF]              = COMPOUND_STRING("Put away the DL{EMOJI_BIGWHEEL}GEAR."),
    [POKENAV_MENUITEM_CONDITION_PARTY]         = COMPOUND_STRING("Check party Fragmon in detail."),
    [POKENAV_MENUITEM_CONDITION_SEARCH]        = COMPOUND_STRING("Check all Fragmon in detail."),
    [POKENAV_MENUITEM_CONDITION_CANCEL]        = COMPOUND_STRING("Return to the DL{EMOJI_BIGWHEEL}GEAR menu."),
    [POKENAV_MENUITEM_CONDITION_SEARCH_COOL]   = COMPOUND_STRING("Find cool Fragmon."),
    [POKENAV_MENUITEM_CONDITION_SEARCH_BEAUTY] = COMPOUND_STRING("Find beautiful Fragmon."),
    [POKENAV_MENUITEM_CONDITION_SEARCH_CUTE]   = COMPOUND_STRING("Find cute Fragmon."),
    [POKENAV_MENUITEM_CONDITION_SEARCH_SMART]  = COMPOUND_STRING("Find smart Fragmon."),
    [POKENAV_MENUITEM_CONDITION_SEARCH_TOUGH]  = COMPOUND_STRING("Find tough Fragmon."),
