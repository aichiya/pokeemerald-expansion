...
int GameClear(void)
{
    ...
    if (gSaveBlock2Ptr->playerGender == MALE)
        SetContinueGameWarpToHealLocation(HEAL_LOCATION_JOHTO_TWINRIVER_CITY); // HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE_2F
    else
        SetContinueGameWarpToHealLocation(HEAL_LOCATION_JOHTO_TWINRIVER_CITY); // HEAL_LOCATION_LITTLEROOT_TOWN_MAYS_HOUSE_2F
