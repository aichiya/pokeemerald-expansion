...
{
    {MAPSEC_REV_JAVA_THOUSAND_DOORS,                       MAPSEC_REV_GENSOKYO_HAKUGYOKUROU},
    {MAPSEC_REV_JOHTO_ROUTE_23,           MAPSEC_REV_JAVA_YOGYAKARTA},
    #ifdef BUGFIX
    {MAPSEC_REV_JAVA_MT_MERAPI_CAVE,                       MAPSEC_REV_JAVA_SOLO},
    #else
    {MAPSEC_REV_JAVA_MT_MERAPI_CAVE,                       MAPSEC_0x2C}, // BUG: Map will incorrectly display the name of Route 129 when diving on Route 125 (for Marine Cave only)
    #endif
    {MAPSEC_REV_JOHTO_ROUTE_26,       MAPSEC_REV_JAVA_SEMARANG},
    {MAPSEC_REV_JOHTO_ROUTE_27,          MAPSEC_REV_JAVA_SURABAYA},
    {MAPSEC_REV_JOHTO_ROUTE_28,     MAPSEC_REV_JAVA_JAKARTA},
    {MAPSEC_REV_JAVA_NATIONAL_MONUMENT,                       MAPSEC_0x2C},
    {MAPSEC_REV_JOHTO_ROUTE_29,            MAPSEC_REV_JOHTO_MORIYA_SHRINE},
    {MAPSEC_REV_JOHTO_ROUTE_43,      MAPSEC_REV_JAVA_JAKARTA},
    {MAPSEC_REV_JAVA_TRAPPY_PASS,         MAPSEC_REV_JOHTO_MT_SILVER},
    {MAPSEC_REV_JOHTO_ROUTE_40,     MAPSEC_REV_JOHTO_MT_SILVER},
    {MAPSEC_REV_JAVA_SEA_BREAK_PASS,          MAPSEC_REV_GENSOKYO_NAMELESS_HILL},
    {MAPSEC_BATTLE_PYRAMID,             MAPSEC_0x31},
    {MAPSEC_REV_JOHTO_ROUTE_33,            MAPSEC_REV_GENSOKYO_MUENZUKA},
    {MAPSEC_BATTLE_DOME,                MAPSEC_REV_GENSOKYO_NAMELESS_HILL},
    {MAPSEC_REV_JOHTO_ROUTE_39,              MAPSEC_REV_YYYI_SEA_OF_FLAME1},
    {MAPSEC_REV_JOHTO_BELL_TOWER,           MAPSEC_0x2E},
    {MAPSEC_REV_JAVA_MIDDLE_PASS,         MAPSEC_REV_GENSOKYO_GARDEN_OF_THE_SUN},
    {MAPSEC_REV_JAVA_LOST_AGE4,                       MAPSEC_REV_GENSOKYO_GARDEN_OF_THE_SUN},
    {MAPSEC_REV_JAVA_LOST_AGE1,                       MAPSEC_REV_GENSOKYO_ANIMAL_REALM},
    {MAPSEC_REV_JAVA_LOST_AGE2,                       MAPSEC_REV_GENSOKYO_KOURINDOU},
    {MAPSEC_ARTISAN_CAVE,               MAPSEC_REV_GENSOKYO_KOURINDOU},
    {MAPSEC_REV_JOHTO_ROUTE_35,          MAPSEC_REV_GENSOKYO_CHIREIDEN},
...
{
    [ABNORMAL_WEATHER_ROUTE_114_NORTH - 1] = MAPSEC_REV_GENSOKYO_ANIMAL_REALM,
    [ABNORMAL_WEATHER_ROUTE_114_SOUTH - 1] = MAPSEC_REV_GENSOKYO_ANIMAL_REALM,
    [ABNORMAL_WEATHER_ROUTE_115_WEST  - 1] = MAPSEC_REV_GENSOKYO_MUGENKAN,
    [ABNORMAL_WEATHER_ROUTE_115_EAST  - 1] = MAPSEC_REV_GENSOKYO_MUGENKAN,
    [ABNORMAL_WEATHER_ROUTE_116_NORTH - 1] = MAPSEC_REV_GENSOKYO_FANTASY_WORLD,
    [ABNORMAL_WEATHER_ROUTE_116_SOUTH - 1] = MAPSEC_REV_GENSOKYO_FANTASY_WORLD,
    [ABNORMAL_WEATHER_ROUTE_118_EAST  - 1] = MAPSEC_REV_GENSOKYO_MAKAI,
    [ABNORMAL_WEATHER_ROUTE_118_WEST  - 1] = MAPSEC_REV_GENSOKYO_MAKAI,
    [ABNORMAL_WEATHER_ROUTE_105_NORTH - 1] = MAPSEC_REV_GENSOKYO_HAKUGYOKUROU,
    [ABNORMAL_WEATHER_ROUTE_105_SOUTH - 1] = MAPSEC_REV_GENSOKYO_HAKUGYOKUROU,
    [ABNORMAL_WEATHER_ROUTE_125_WEST  - 1] = MAPSEC_REV_JAVA_SOLO,
    [ABNORMAL_WEATHER_ROUTE_125_EAST  - 1] = MAPSEC_REV_JAVA_SOLO,
    [ABNORMAL_WEATHER_ROUTE_127_NORTH - 1] = MAPSEC_REV_JAVA_SURABAYA,
    [ABNORMAL_WEATHER_ROUTE_127_SOUTH - 1] = MAPSEC_REV_JAVA_SURABAYA,
    [ABNORMAL_WEATHER_ROUTE_129_WEST  - 1] = MAPSEC_0x2C,
    [ABNORMAL_WEATHER_ROUTE_129_EAST  - 1] = MAPSEC_0x2C
};
...
{
    MAPSEC_REV_JOHTO_SINJOH_RUINS,
    MAPSEC_REV_KEY_ILLUSIONARY_WORLD1,
    MAPSEC_REV_KEY_ILLUSIONARY_WORLD2,
    MAPSEC_REV_KEY_ILLUSIONARY_WORLD3,
    MAPSEC_REV_KEY_ILLUSIONARY_WORLD4,
    MAPSEC_REV_KEY_ILLUSIONARY_WORLD5,
    MAPSEC_REV_YYYI_SEA_OF_TREES1,
    MAPSEC_REV_YYYI_SEA_OF_TREES2,
    MAPSEC_REV_YYYI_SEA_OF_TREES3,
    MAPSEC_REV_YYYI_SEA_OF_TREES4,
    MAPSEC_REV_YYYI_SEA_OF_TREES5,
    MAPSEC_REV_YYYI_SEA_OF_FLAME1,
    MAPSEC_REV_YYYI_SEA_OF_FLAME2,
    MAPSEC_REV_YYYI_SEA_OF_FLAME3,
    MAPSEC_REV_YYYI_SEA_OF_FLAME4,
    MAPSEC_REV_YYYI_SEA_OF_FLAME5,
    MAPSEC_REV_YYYI_DIVINE_TREE,
    MAPSEC_REV_KEY_ILLUSIONARY_WORLD1,
    MAPSEC_REV_KEY_ILLUSIONARY_WORLD2,
    MAPSEC_REV_KEY_ILLUSIONARY_WORLD3,
    MAPSEC_REV_KEY_ILLUSIONARY_WORLD4,
    MAPSEC_REV_KEY_ILLUSIONARY_WORLD5,
    MAPSEC_REV_BGHS_DIVINE_TREE,
    MAPSEC_REV_ETC_AURORA_CURTAIN,
    MAPSEC_REV_ETC_DIMENSIONAL_RIFT,
    MAPSEC_REV_ETC_DENLINER,
    MAPSEC_REV_ETC_DIGITAL_WORLD,
    MAPSEC_REV_ETC_HOSPITAL,
    MAPSEC_REV_ETC_VOID,
    MAPSEC_REV_ETC_ENDING,
    MAPSEC_REV_JAVA_MT_MERAPI,
    MAPSEC_REV_JAVA_NORTHERN_PASS,
    MAPSEC_REV_JAVA_SOUTHERN_PASS,
    MAPSEC_REV_JAVA_TRAPPY_PASS,
    MAPSEC_REV_JAVA_SEA_BREAK_PASS,
    MAPSEC_REV_JAVA_MIDDLE_PASS,
    MAPSEC_REV_JAVA_EASTERN_PASS,
    MAPSEC_REV_JAVA_WESTERN_PASS,
    MAPSEC_REV_JAVA_POJOK_CLIFF,
    MAPSEC_REV_JAVA_SULTAN_PALACE,
    MAPSEC_REV_JAVA_SUNAN_PALACE,
    MAPSEC_REV_JAVA_SURABAYA_ZONE,
    MAPSEC_REV_JAVA_THOUSAND_DOORS,
    MAPSEC_REV_JAVA_MT_MERAPI_CAVE,
    MAPSEC_REV_JAVA_NATIONAL_MONUMENT,
    MAPSEC_REV_JAVA_LOST_AGE1,
    MAPSEC_REV_JAVA_LOST_AGE2,
    MAPSEC_REV_JAVA_LOST_AGE3,
    MAPSEC_REV_JAVA_LOST_AGE4,
    MAPSEC_0xD5,
    MAPSEC_0xD6,
    MAPSEC_0xD7,
    MAPSEC_0xD8,
...
{
    [MAPSEC_LITTLEROOT_TOWN] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), HEAL_LOCATION_JOHTO_TWINRIVER_CITY_MC_HOUSE_2F_MALE},
    [MAPSEC_OLDALE_TOWN] = {MAP_GROUP(OLDALE_TOWN), MAP_NUM(OLDALE_TOWN), HEAL_LOCATION_JOHTO_NEW_BARK_TOWN},
    [MAPSEC_DEWFORD_TOWN] = {MAP_GROUP(DEWFORD_TOWN), MAP_NUM(DEWFORD_TOWN), HEAL_LOCATION_JOHTO_CHERRYGROVE_CITY},
    [MAPSEC_LAVARIDGE_TOWN] = {MAP_GROUP(LAVARIDGE_TOWN), MAP_NUM(LAVARIDGE_TOWN), HEAL_LOCATION_JOHTO_VIOLET_CITY},
    [MAPSEC_FALLARBOR_TOWN] = {MAP_GROUP(FALLARBOR_TOWN), MAP_NUM(FALLARBOR_TOWN), HEAL_LOCATION_JOHTO_AZALEA_TOWN},
    [MAPSEC_VERDANTURF_TOWN] = {MAP_GROUP(VERDANTURF_TOWN), MAP_NUM(VERDANTURF_TOWN), HEAL_LOCATION_JOHTO_CIANWOOD_CITY},
    [MAPSEC_PACIFIDLOG_TOWN] = {MAP_GROUP(PACIFIDLOG_TOWN), MAP_NUM(PACIFIDLOG_TOWN), HEAL_LOCATION_JOHTO_GOLDENROD_CITY},
    [MAPSEC_PETALBURG_CITY] = {MAP_GROUP(PETALBURG_CITY), MAP_NUM(PETALBURG_CITY), HEAL_LOCATION_JOHTO_OLIVINE_CITY},
    [MAPSEC_SLATEPORT_CITY] = {MAP_GROUP(SLATEPORT_CITY), MAP_NUM(SLATEPORT_CITY), HEAL_LOCATION_JOHTO_ECRUTEAK_CITY},
    [MAPSEC_MAUVILLE_CITY] = {MAP_GROUP(MAUVILLE_CITY), MAP_NUM(MAUVILLE_CITY), HEAL_LOCATION_JOHTO_MAHOGANY_TOWN},
    [MAPSEC_RUSTBORO_CITY] = {MAP_GROUP(RUSTBORO_CITY), MAP_NUM(RUSTBORO_CITY), HEAL_LOCATION_JOHTO_LAKE_OF_RAGE},
    [MAPSEC_FORTREE_CITY] = {MAP_GROUP(FORTREE_CITY), MAP_NUM(FORTREE_CITY), HEAL_LOCATION_JOHTO_BLACKTHORN_CITY},
    [MAPSEC_LILYCOVE_CITY] = {MAP_GROUP(LILYCOVE_CITY), MAP_NUM(LILYCOVE_CITY), HEAL_LOCATION_JOHTO_MT_SILVER},
    [MAPSEC_MOSSDEEP_CITY] = {MAP_GROUP(MOSSDEEP_CITY), MAP_NUM(MOSSDEEP_CITY), HEAL_LOCATION_JOHTO_INDIGO_PLATEAU},
    [MAPSEC_SOOTOPOLIS_CITY] = {MAP_GROUP(SOOTOPOLIS_CITY), MAP_NUM(SOOTOPOLIS_CITY), HEAL_LOCATION_JOHTO_MORIYA_SHRINE},
    [MAPSEC_EVER_GRANDE_CITY] = {MAP_GROUP(EVER_GRANDE_CITY), MAP_NUM(EVER_GRANDE_CITY), HEAL_LOCATION_JOHTO_SPACE_HYPER_VESSEL_FRONT},
    [MAPSEC_ROUTE_101] = {MAP_GROUP(ROUTE101), MAP_NUM(ROUTE101), HEAL_LOCATION_GENSOKYO_HAKUREI_SHRINE},
    [MAPSEC_ROUTE_102] = {MAP_GROUP(ROUTE102), MAP_NUM(ROUTE102), HEAL_LOCATION_GENSOKYO_HUMAN_VILLAGE},
    [MAPSEC_ROUTE_103] = {MAP_GROUP(ROUTE103), MAP_NUM(ROUTE103), HEAL_LOCATION_GENSOKYO_KOURINDOU},
    [MAPSEC_ROUTE_104] = {MAP_GROUP(ROUTE104), MAP_NUM(ROUTE104), HEAL_LOCATION_GENSOKYO_MUENZUKA},
    [MAPSEC_ROUTE_105] = {MAP_GROUP(ROUTE105), MAP_NUM(ROUTE105), HEAL_LOCATION_GENSOKYO_HAKUGYOKUROU},
    [MAPSEC_ROUTE_106] = {MAP_GROUP(ROUTE106), MAP_NUM(ROUTE106), HEAL_LOCATION_GENSOKYO_MORIYA_SHRINE},
    [MAPSEC_ROUTE_107] = {MAP_GROUP(ROUTE107), MAP_NUM(ROUTE107), HEAL_LOCATION_GENSOKYO_SCARLET_DEVIL_MANSION},
    [MAPSEC_ROUTE_108] = {MAP_GROUP(ROUTE108), MAP_NUM(ROUTE108), HEAL_LOCATION_GENSOKYO_CHIREIDEN},
    [MAPSEC_ROUTE_109] = {MAP_GROUP(ROUTE109), MAP_NUM(ROUTE109), HEAL_LOCATION_GENSOKYO_PALENQUIN_SHIP},
    [MAPSEC_ROUTE_110] = {MAP_GROUP(ROUTE110), MAP_NUM(ROUTE110), HEAL_LOCATION_GENSOKYO_SANZU_RIVER},
    [MAPSEC_ROUTE_111] = {MAP_GROUP(ROUTE111), MAP_NUM(ROUTE111), HEAL_LOCATION_GENSOKYO_GARDEN_OF_THE_SUN},
    [MAPSEC_ROUTE_112] = {MAP_GROUP(ROUTE112), MAP_NUM(ROUTE112), HEAL_LOCATION_GENSOKYO_NAMELESS_HILL},
    [MAPSEC_ROUTE_113] = {MAP_GROUP(ROUTE113), MAP_NUM(ROUTE113), HEAL_LOCATION_GENSOKYO_EIENTEI},
    [MAPSEC_ROUTE_114] = {MAP_GROUP(ROUTE114), MAP_NUM(ROUTE114), HEAL_LOCATION_GENSOKYO_ANIMAL_REALM},
    [MAPSEC_ROUTE_115] = {MAP_GROUP(ROUTE115), MAP_NUM(ROUTE115), HEAL_LOCATION_GENSOKYO_MUGENKAN},
    [MAPSEC_ROUTE_116] = {MAP_GROUP(ROUTE116), MAP_NUM(ROUTE116), HEAL_LOCATION_GENSOKYO_FANTASY_WORLD},
    [MAPSEC_ROUTE_117] = {MAP_GROUP(ROUTE117), MAP_NUM(ROUTE117), HEAL_LOCATION_GENSOKYO_DREAM_WORLD},
    [MAPSEC_ROUTE_118] = {MAP_GROUP(ROUTE118), MAP_NUM(ROUTE118), HEAL_LOCATION_GENSOKYO_MAKAI},
    [MAPSEC_ROUTE_119] = {MAP_GROUP(ROUTE119), MAP_NUM(ROUTE119), HEAL_LOCATION_GENSOKYO_LUNAR_CAPITAL},
    [MAPSEC_ROUTE_120] = {MAP_GROUP(ROUTE120), MAP_NUM(ROUTE120), HEAL_LOCATION_GENSOKYO_FANTASY_LEAGUE},
    [MAPSEC_ROUTE_121] = {MAP_GROUP(ROUTE121), MAP_NUM(ROUTE121), HEAL_LOCATION_YYYI_SEA_OF_TREES1},
    [MAPSEC_ROUTE_122] = {MAP_GROUP(ROUTE122), MAP_NUM(ROUTE122), HEAL_LOCATION_YYYI_SEA_OF_FLAME1},
    [MAPSEC_ROUTE_123] = {MAP_GROUP(ROUTE123), MAP_NUM(ROUTE123), HEAL_LOCATION_KEY_ILLUSIONARY_WORLD1},
    [MAPSEC_ROUTE_124] = {MAP_GROUP(ROUTE124), MAP_NUM(ROUTE124), HEAL_LOCATION_JAVA_YOGYAKARTA},
    [MAPSEC_ROUTE_125] = {MAP_GROUP(ROUTE125), MAP_NUM(ROUTE125), HEAL_LOCATION_JAVA_SOLO},
    [MAPSEC_ROUTE_126] = {MAP_GROUP(ROUTE126), MAP_NUM(ROUTE126), HEAL_LOCATION_JAVA_SEMARANG},
    [MAPSEC_ROUTE_127] = {MAP_GROUP(ROUTE127), MAP_NUM(ROUTE127), HEAL_LOCATION_JAVA_SURABAYA},
    [MAPSEC_ROUTE_128] = {MAP_GROUP(ROUTE128), MAP_NUM(ROUTE128), HEAL_LOCATION_JAVA_JAKARTA},
    [MAPSEC_ROUTE_129] = {MAP_GROUP(ROUTE129), MAP_NUM(ROUTE129), HEAL_LOCATION_INMAP0x2C},
    [MAPSEC_ROUTE_130] = {MAP_GROUP(ROUTE130), MAP_NUM(ROUTE130), HEAL_LOCATION_INMAP0x2D},
    [MAPSEC_ROUTE_131] = {MAP_GROUP(ROUTE131), MAP_NUM(ROUTE131), HEAL_LOCATION_INMAP0x2E},
    [MAPSEC_ROUTE_132] = {MAP_GROUP(ROUTE132), MAP_NUM(ROUTE132), HEAL_LOCATION_INMAP0x2F},
    [MAPSEC_ROUTE_133] = {MAP_GROUP(ROUTE133), MAP_NUM(ROUTE133), HEAL_LOCATION_INMAP0x30},
    [MAPSEC_ROUTE_134] = {MAP_GROUP(ROUTE134), MAP_NUM(ROUTE134), HEAL_LOCATION_INMAP0x31},
};
...
{
    {
        ...
        .mapSecId = MAPSEC_REV_JOHTO_SPACE_HYPER_VESSEL,
...
static void InitMapBasedOnPlayerLocation(void)
{
    ...
    case MAP_TYPE_OCEAN_ROUTE:
        ...
        if (sRegionMap->mapSecId == MAPSEC_REV_JOHTO_ROUTE_43 || sRegionMap->mapSecId == MAPSEC_REV_JAVA_SUNAN_PALACE)
    ...
    {
    case MAPSEC_REV_GENSOKYO_ANIMAL_REALM:
        if (y != 0)
            x = 0;
        break;
    case MAPSEC_REV_JAVA_SEMARANG:
    case MAPSEC_REV_JOHTO_ROUTE_26:
        x = 0;
        ...
        if (gSaveBlock1Ptr->pos.y > 56)
            y++;
        break;
    case MAPSEC_REV_YYYI_SEA_OF_TREES1:
        x = 0;
        if (xOnMap > 14)
            x++;
        if (xOnMap > 28)
        ...
        if (xOnMap > 54)
            x++;
        break;
    case MAPSEC_REV_JAVA_SUNAN_PALACE:
...
static void RegionMap_InitializeStateBasedOnSSTidalLocation(void)
{
    ...
    case SS_TIDAL_LOCATION_SLATEPORT:
        sRegionMap->mapSecId = MAPSEC_REV_JOHTO_ECRUTEAK_CITY;
        break;
    case SS_TIDAL_LOCATION_LILYCOVE:
        sRegionMap->mapSecId = MAPSEC_REV_JOHTO_MT_SILVER;
        break;
    case SS_TIDAL_LOCATION_ROUTE124:
        sRegionMap->mapSecId = MAPSEC_REV_JAVA_YOGYAKARTA;
        break;
    case SS_TIDAL_LOCATION_ROUTE131:
        sRegionMap->mapSecId = MAPSEC_0x2E;
        break;
    default:
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_REV_JAVA_SURABAYA:
        return FlagGet(FLAG_VISITED_JAVA_SURABAYA) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_REV_JAVA_JAKARTA:
        return FlagGet(FLAG_VISITED_JAVA_JAKARTA) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_0x2C:
        return FlagGet(FLAG_VISITED_INMAP0x2C) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_0x2D:
        return FlagGet(FLAG_VISITED_INMAP0x2D) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_0x2E:
        return FlagGet(FLAG_VISITED_INMAP0x2E) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_0x2F:
        return FlagGet(FLAG_VISITED_INMAP0x2F) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_0x30:
        return FlagGet(FLAG_VISITED_INMAP0x30) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_0x31:
        return FlagGet(FLAG_VISITED_INMAP0x31) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    default:
...
{
    if (mapSecId == MAPSEC_REV_JOHTO_ROUTE_40)
...
static void CreateFlyDestIcons(void)
{
    ...
    for (mapSecId = MAPSEC_REV_JOHTO_TWINRIVER_CITY; mapSecId <= MAPSEC_0x31; mapSecId++)
    {
