...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_JAVA_KEMBANG_TOWN] = {MAP_GROUP(ROUTE112), MAP_NUM(ROUTE112), HEAL_LOCATION_JAVA_KEMBANG_TOWN},
    ...
    [MAPSEC_JAVA_NEO_BANJAR_CITY] = {MAP_GROUP(ROUTE115), MAP_NUM(ROUTE115), HEAL_LOCATION_JAVA_NEO_BANJAR_CITY},
    ...
    [MAPSEC_JOHTO_ROUTE_48_POKEMON_CENTER] = {MAP_GROUP(ROUTE129), MAP_NUM(ROUTE129), HEAL_LOCATION_JOHTO_ROUTE_48_POKEMON_CENTER},
    [MAPSEC_JOHTO_NOBELESSE_CITY] = {MAP_GROUP(ROUTE130), MAP_NUM(ROUTE130), HEAL_LOCATION_JOHTO_NOBELESSE_CITY},
    [MAPSEC_JAVA_MALANG] = {MAP_GROUP(ROUTE131), MAP_NUM(ROUTE131), HEAL_LOCATION_JAVA_MALANG},
    [MAPSEC_JAVA_DEVATA_ISLETS] = {MAP_GROUP(ROUTE132), MAP_NUM(ROUTE132), HEAL_LOCATION_JAVA_DEVATA_ISLETS},
    [MAPSEC_JAVA_KASEPUHAN_TOWN] = {MAP_GROUP(ROUTE133), MAP_NUM(ROUTE133), HEAL_LOCATION_JAVA_KASEPUHAN_TOWN},
    [MAPSEC_JAVA_CILA_PRISON_TOWN] = {MAP_GROUP(ROUTE134), MAP_NUM(ROUTE134), HEAL_LOCATION_JAVA_CILA_PRISON_TOWN},
};
