...
static const u16 sTerraOrMarineCaveMapSecIds[ABNORMAL_WEATHER_LOCATIONS] =
{
    ...
    [ABNORMAL_WEATHER_ROUTE_115_WEST  - 1] = MAPSEC_GENSOKYO_MUGENKAN,
    [ABNORMAL_WEATHER_ROUTE_115_EAST  - 1] = MAPSEC_GENSOKYO_MUGENKAN,
...
static const u8 sMapSecIdsOffMap[] =
{
    ...
    MAPSEC_JAVA_LOST_AGE1,
    MAPSEC_JAVA_LOST_AGE2,
    MAPSEC_JAVA_LOST_AGE3,
    MAPSEC_JAVA_LOST_AGE4,
    MAPSEC_0XD5,
    MAPSEC_0XD6,
    MAPSEC_0XD7,
    MAPSEC_0XD8,
...
{
    [MAPSEC_JOHTO_TWINRIVER_CITY] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), HEAL_LOCATION_JOHTO_TWINRIVER_CITY_MC_HOUSE_2F_MALE},
    [MAPSEC_JOHTO_NEW_BARK_TOWN] = {MAP_GROUP(OLDALE_TOWN), MAP_NUM(OLDALE_TOWN), HEAL_LOCATION_JOHTO_NEW_BARK_TOWN},
    [MAPSEC_JOHTO_CHERRYGROVE_CITY] = {MAP_GROUP(DEWFORD_TOWN), MAP_NUM(DEWFORD_TOWN), HEAL_LOCATION_JOHTO_CHERRYGROVE_CITY},
    [MAPSEC_JOHTO_VIOLET_CITY] = {MAP_GROUP(LAVARIDGE_TOWN), MAP_NUM(LAVARIDGE_TOWN), HEAL_LOCATION_JOHTO_VIOLET_CITY},
    [MAPSEC_JOHTO_AZALEA_TOWN] = {MAP_GROUP(FALLARBOR_TOWN), MAP_NUM(FALLARBOR_TOWN), HEAL_LOCATION_JOHTO_AZALEA_TOWN},
    [MAPSEC_JOHTO_CIANWOOD_CITY] = {MAP_GROUP(VERDANTURF_TOWN), MAP_NUM(VERDANTURF_TOWN), HEAL_LOCATION_JOHTO_CIANWOOD_CITY},
    [MAPSEC_JOHTO_GOLDENROD_CITY] = {MAP_GROUP(PACIFIDLOG_TOWN), MAP_NUM(PACIFIDLOG_TOWN), HEAL_LOCATION_JOHTO_GOLDENROD_CITY},
    [MAPSEC_JOHTO_OLIVINE_CITY] = {MAP_GROUP(PETALBURG_CITY), MAP_NUM(PETALBURG_CITY), HEAL_LOCATION_JOHTO_OLIVINE_CITY},
    [MAPSEC_JOHTO_ECRUTEAK_CITY] = {MAP_GROUP(SLATEPORT_CITY), MAP_NUM(SLATEPORT_CITY), HEAL_LOCATION_JOHTO_ECRUTEAK_CITY},
    [MAPSEC_JOHTO_MAHOGANY_TOWN] = {MAP_GROUP(MAUVILLE_CITY), MAP_NUM(MAUVILLE_CITY), HEAL_LOCATION_JOHTO_MAHOGANY_TOWN},
    [MAPSEC_JOHTO_LAKE_OF_RAGE] = {MAP_GROUP(RUSTBORO_CITY), MAP_NUM(RUSTBORO_CITY), HEAL_LOCATION_JOHTO_LAKE_OF_RAGE},
    [MAPSEC_JOHTO_BLACKTHORN_CITY] = {MAP_GROUP(FORTREE_CITY), MAP_NUM(FORTREE_CITY), HEAL_LOCATION_JOHTO_BLACKTHORN_CITY},
    [MAPSEC_JOHTO_MT_SILVER] = {MAP_GROUP(LILYCOVE_CITY), MAP_NUM(LILYCOVE_CITY), HEAL_LOCATION_JOHTO_MT_SILVER},
    [MAPSEC_JOHTO_INDIGO_PLATEAU] = {MAP_GROUP(MOSSDEEP_CITY), MAP_NUM(MOSSDEEP_CITY), HEAL_LOCATION_JOHTO_INDIGO_PLATEAU},
    [MAPSEC_JOHTO_MORIYA_SHRINE] = {MAP_GROUP(SOOTOPOLIS_CITY), MAP_NUM(SOOTOPOLIS_CITY), HEAL_LOCATION_JOHTO_MORIYA_SHRINE},
    [MAPSEC_JOHTO_SPACE_HYPER_VESSEL] = {MAP_GROUP(EVER_GRANDE_CITY), MAP_NUM(EVER_GRANDE_CITY), HEAL_LOCATION_JOHTO_SPACE_HYPER_VESSEL_FRONT},
    [MAPSEC_GENSOKYO_HAKUREI_SHRINE] = {MAP_GROUP(ROUTE101), MAP_NUM(ROUTE101), HEAL_LOCATION_GENSOKYO_HAKUREI_SHRINE},
    [MAPSEC_GENSOKYO_HUMAN_VILLAGE] = {MAP_GROUP(ROUTE102), MAP_NUM(ROUTE102), HEAL_LOCATION_GENSOKYO_HUMAN_VILLAGE},
    [MAPSEC_GENSOKYO_KOURINDOU] = {MAP_GROUP(ROUTE103), MAP_NUM(ROUTE103), HEAL_LOCATION_GENSOKYO_KOURINDOU},
    [MAPSEC_GENSOKYO_MUENZUKA] = {MAP_GROUP(ROUTE104), MAP_NUM(ROUTE104), HEAL_LOCATION_GENSOKYO_MUENZUKA},
    [MAPSEC_GENSOKYO_HAKUGYOKUROU] = {MAP_GROUP(ROUTE105), MAP_NUM(ROUTE105), HEAL_LOCATION_GENSOKYO_HAKUGYOKUROU},
    [MAPSEC_GENSOKYO_MORIYA_SHRINE] = {MAP_GROUP(ROUTE106), MAP_NUM(ROUTE106), HEAL_LOCATION_GENSOKYO_MORIYA_SHRINE},
    [MAPSEC_GENSOKYO_SCARLET_DEVIL_MANSION] = {MAP_GROUP(ROUTE107), MAP_NUM(ROUTE107), HEAL_LOCATION_GENSOKYO_SCARLET_DEVIL_MANSION},
    [MAPSEC_GENSOKYO_CHIREIDEN] = {MAP_GROUP(ROUTE108), MAP_NUM(ROUTE108), HEAL_LOCATION_GENSOKYO_CHIREIDEN},
    [MAPSEC_GENSOKYO_PALENQUIN_SHIP] = {MAP_GROUP(ROUTE109), MAP_NUM(ROUTE109), HEAL_LOCATION_GENSOKYO_PALENQUIN_SHIP},
    [MAPSEC_GENSOKYO_SANZU_RIVER] = {MAP_GROUP(ROUTE110), MAP_NUM(ROUTE110), HEAL_LOCATION_GENSOKYO_SANZU_RIVER},
    [MAPSEC_GENSOKYO_GARDEN_OF_THE_SUN] = {MAP_GROUP(ROUTE111), MAP_NUM(ROUTE111), HEAL_LOCATION_GENSOKYO_GARDEN_OF_THE_SUN},
    [MAPSEC_GENSOKYO_NAMELESS_HILL] = {MAP_GROUP(ROUTE112), MAP_NUM(ROUTE112), HEAL_LOCATION_GENSOKYO_NAMELESS_HILL},
    [MAPSEC_GENSOKYO_EIENTEI] = {MAP_GROUP(ROUTE113), MAP_NUM(ROUTE113), HEAL_LOCATION_GENSOKYO_EIENTEI},
    [MAPSEC_GENSOKYO_ANIMAL_REALM] = {MAP_GROUP(ROUTE114), MAP_NUM(ROUTE114), HEAL_LOCATION_GENSOKYO_ANIMAL_REALM},
    [MAPSEC_GENSOKYO_MUGENKAN] = {MAP_GROUP(ROUTE115), MAP_NUM(ROUTE115), HEAL_LOCATION_GENSOKYO_MUGENKAN},
    [MAPSEC_GENSOKYO_FANTASY_WORLD] = {MAP_GROUP(ROUTE116), MAP_NUM(ROUTE116), HEAL_LOCATION_GENSOKYO_FANTASY_WORLD},
    [MAPSEC_GENSOKYO_DREAM_WORLD] = {MAP_GROUP(ROUTE117), MAP_NUM(ROUTE117), HEAL_LOCATION_GENSOKYO_DREAM_WORLD},
    [MAPSEC_GENSOKYO_MAKAI] = {MAP_GROUP(ROUTE118), MAP_NUM(ROUTE118), HEAL_LOCATION_GENSOKYO_MAKAI},
    [MAPSEC_GENSOKYO_LUNAR_CAPITAL] = {MAP_GROUP(ROUTE119), MAP_NUM(ROUTE119), HEAL_LOCATION_GENSOKYO_LUNAR_CAPITAL},
    [MAPSEC_GENSOKYO_FANTASY_LEAGUE] = {MAP_GROUP(ROUTE120), MAP_NUM(ROUTE120), HEAL_LOCATION_GENSOKYO_FANTASY_LEAGUE},
    [MAPSEC_YYYI_SEA_OF_TREES1] = {MAP_GROUP(ROUTE121), MAP_NUM(ROUTE121), HEAL_LOCATION_YYYI_SEA_OF_TREES1},
    [MAPSEC_YYYI_SEA_OF_FLAME1] = {MAP_GROUP(ROUTE122), MAP_NUM(ROUTE122), HEAL_LOCATION_YYYI_SEA_OF_FLAME1},
    [MAPSEC_KEY_ILLUSIONARY_WORLD1] = {MAP_GROUP(ROUTE123), MAP_NUM(ROUTE123), HEAL_LOCATION_KEY_ILLUSIONARY_WORLD1},
    [MAPSEC_JAVA_YOGYAKARTA] = {MAP_GROUP(ROUTE124), MAP_NUM(ROUTE124), HEAL_LOCATION_JAVA_YOGYAKARTA},
    [MAPSEC_JAVA_SOLO] = {MAP_GROUP(ROUTE125), MAP_NUM(ROUTE125), HEAL_LOCATION_JAVA_SOLO},
    [MAPSEC_JAVA_SEMARANG] = {MAP_GROUP(ROUTE126), MAP_NUM(ROUTE126), HEAL_LOCATION_JAVA_SEMARANG},
    [MAPSEC_JAVA_SURABAYA] = {MAP_GROUP(ROUTE127), MAP_NUM(ROUTE127), HEAL_LOCATION_JAVA_SURABAYA},
    [MAPSEC_JAVA_JAKARTA] = {MAP_GROUP(ROUTE128), MAP_NUM(ROUTE128), HEAL_LOCATION_JAVA_JAKARTA},
    [MAPSEC_0X2C] = {MAP_GROUP(ROUTE129), MAP_NUM(ROUTE129), HEAL_LOCATION_INMAP0x2C},
    [MAPSEC_0X2D] = {MAP_GROUP(ROUTE130), MAP_NUM(ROUTE130), HEAL_LOCATION_INMAP0x2D},
    [MAPSEC_0X2E] = {MAP_GROUP(ROUTE131), MAP_NUM(ROUTE131), HEAL_LOCATION_INMAP0x2E},
    [MAPSEC_0X2F] = {MAP_GROUP(ROUTE132), MAP_NUM(ROUTE132), HEAL_LOCATION_INMAP0x2F},
    [MAPSEC_0X30] = {MAP_GROUP(ROUTE133), MAP_NUM(ROUTE133), HEAL_LOCATION_INMAP0x30},
    [MAPSEC_0X31] = {MAP_GROUP(ROUTE134), MAP_NUM(ROUTE134), HEAL_LOCATION_INMAP0x31},
};
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_GENSOKYO_NAMELESS_HILL:
...
static void CreateFlyDestIcons(void)
{
    ...
    for (mapSecId = MAPSEC_JOHTO_TWINRIVER_CITY; mapSecId <= MAPSEC_0X31; mapSecId++)
    {
