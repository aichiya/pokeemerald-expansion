...
{
    {MAPSEC_0xCE,                       MAPSEC_JOHTO_ROUTE_29},
    {MAPSEC_JOHTO_LIGHTHOUSE,           MAPSEC_JOHTO_ROUTE_48},
    #ifdef BUGFIX
    {MAPSEC_0xCF,                       MAPSEC_JOHTO_ROUTE_49},
    #else
    {MAPSEC_0xCF,                       MAPSEC_JOHTO_BURNED_TOWER}, // BUG: Map will incorrectly display the name of Route 129 when diving on Route 125 (for Marine Cave only)
    #endif
    {MAPSEC_JOHTO_TEAM_ROCKET_HQ,       MAPSEC_JOHTO_ROUTE_50},
    {MAPSEC_JOHTO_ILEX_FOREST,          MAPSEC_JOHTO_SPROUT_TOWER},
    {MAPSEC_JOHTO_GOLDENROD_TUNNEL,     MAPSEC_JOHTO_BELL_TOWER},
    {MAPSEC_0xD0,                       MAPSEC_JOHTO_BURNED_TOWER},
    {MAPSEC_JOHTO_MT_MORTAR,            MAPSEC_JOHTO_MORIYA_SHRINE},
    {MAPSEC_JOHTO_BELLCHIME_TRAIL,      MAPSEC_JOHTO_BELL_TOWER},
    {MAPSEC_JAVA_SULTAN_PALACE,         MAPSEC_JOHTO_MT_SILVER},
    {MAPSEC_JOHTO_SAFARI_ZONE_GATE,     MAPSEC_JOHTO_MT_SILVER},
    {MAPSEC_JAVA_SUNAN_PALACE,          MAPSEC_JOHTO_ROUTE_36},
    {MAPSEC_BATTLE_PYRAMID,             MAPSEC_JOHTO_SLOWPOKE_WELL},
    {MAPSEC_JOHTO_DARK_CAVE,            MAPSEC_JOHTO_ROUTE_28},
    {MAPSEC_BATTLE_DOME,                MAPSEC_JOHTO_ROUTE_36},
    {MAPSEC_JOHTO_SS_AQUA,              MAPSEC_JOHTO_ROUTE_46},
    {MAPSEC_JOHTO_SILK_ROAD3,           MAPSEC_JOHTO_RADIO_TOWER},
    {MAPSEC_JAVA_SURABAYA_ZONE,         MAPSEC_JOHTO_ROUTE_35},
    {MAPSEC_0xD4,                       MAPSEC_JOHTO_ROUTE_35},
    {MAPSEC_0xD1,                       MAPSEC_JOHTO_ROUTE_38},
    {MAPSEC_0xD2,                       MAPSEC_JOHTO_ROUTE_27},
    {MAPSEC_ARTISAN_CAVE,               MAPSEC_JOHTO_ROUTE_27},
    {MAPSEC_JOHTO_DRAGONS_DEN,          MAPSEC_JOHTO_ROUTE_32},
...
{
    [ABNORMAL_WEATHER_ROUTE_114_NORTH - 1] = MAPSEC_JOHTO_ROUTE_38,
    [ABNORMAL_WEATHER_ROUTE_114_SOUTH - 1] = MAPSEC_JOHTO_ROUTE_38,
    [ABNORMAL_WEATHER_ROUTE_115_WEST  - 1] = MAPSEC_JOHTO_ROUTE_39,
    [ABNORMAL_WEATHER_ROUTE_115_EAST  - 1] = MAPSEC_JOHTO_ROUTE_39,
    [ABNORMAL_WEATHER_ROUTE_116_NORTH - 1] = MAPSEC_JOHTO_ROUTE_40,
    [ABNORMAL_WEATHER_ROUTE_116_SOUTH - 1] = MAPSEC_JOHTO_ROUTE_40,
    [ABNORMAL_WEATHER_ROUTE_118_EAST  - 1] = MAPSEC_JOHTO_ROUTE_42,
    [ABNORMAL_WEATHER_ROUTE_118_WEST  - 1] = MAPSEC_JOHTO_ROUTE_42,
    [ABNORMAL_WEATHER_ROUTE_105_NORTH - 1] = MAPSEC_JOHTO_ROUTE_29,
    [ABNORMAL_WEATHER_ROUTE_105_SOUTH - 1] = MAPSEC_JOHTO_ROUTE_29,
    [ABNORMAL_WEATHER_ROUTE_125_WEST  - 1] = MAPSEC_JOHTO_ROUTE_49,
    [ABNORMAL_WEATHER_ROUTE_125_EAST  - 1] = MAPSEC_JOHTO_ROUTE_49,
    [ABNORMAL_WEATHER_ROUTE_127_NORTH - 1] = MAPSEC_JOHTO_SPROUT_TOWER,
    [ABNORMAL_WEATHER_ROUTE_127_SOUTH - 1] = MAPSEC_JOHTO_SPROUT_TOWER,
    [ABNORMAL_WEATHER_ROUTE_129_WEST  - 1] = MAPSEC_JOHTO_BURNED_TOWER,
    [ABNORMAL_WEATHER_ROUTE_129_EAST  - 1] = MAPSEC_JOHTO_BURNED_TOWER
};
...
static const u8 sMapSecIdsOffMap[] =
{
    ...
    MAPSEC_YYYI_SANSHUU_SCHOOL,
    MAPSEC_YYYI_SHINJUKAN_SCHOOL,
    ...
    MAPSEC_BGHS_SHINJUGAMINE_SCHOOL,
    ...
    MAPSEC_ETC_VOID,
    MAPSEC_ETC_ENDING,
    MAPSEC_JAVA_YOGYAKARTA,
    MAPSEC_JAVA_SOLO,
    MAPSEC_JAVA_SEMARANG,
    MAPSEC_JAVA_SURABAYA,
    MAPSEC_JAVA_JAKARTA,
    ...
    MAPSEC_ETC_LOVELY_PLACE,
    MAPSEC_ETC_POKEMON_RANGER,
    MAPSEC_ETC_FARAWAY_PLACE,
    MAPSEC_ETC_POKEMON_MOVIE,
    MAPSEC_ETC_POKEMON_CARTOON,
    MAPSEC_ETC_SPACE_WORLD,
    MAPSEC_ETC_POKEMON_FESTA,
    MAPSEC_ETC_POKEPARK,
    MAPSEC_ETC_POKEMON_CENTER,
    MAPSEC_ETC_NINTENDO_WORLD,
    MAPSEC_ETC_POKEMON_EVENT,
    MAPSEC_ETC_WIFI_EVENT,
    MAPSEC_ETC_WIFI_GIFT,
    MAPSEC_ETC_POKEMON_FAN_CLUB,
    MAPSEC_ETC_EVENT_SITE,
    MAPSEC_ETC_CONCERT_EVENT,
...
static void InitMapBasedOnPlayerLocation(void)
{
    ...
    case MAP_TYPE_OCEAN_ROUTE:
        ...
        if (sRegionMap->mapSecId == MAPSEC_JOHTO_BELLCHIME_TRAIL || sRegionMap->mapSecId == MAPSEC_JAVA_LOST_AGE2)
    ...
    {
    case MAPSEC_JOHTO_ROUTE_38:
        if (y != 0)
            x = 0;
        break;
    case MAPSEC_JOHTO_ROUTE_50:
...
static void RegionMap_InitializeStateBasedOnSSTidalLocation(void)
{
    ...
    case SS_TIDAL_LOCATION_ROUTE124:
        sRegionMap->mapSecId = MAPSEC_JOHTO_ROUTE_48;
        break;
    case SS_TIDAL_LOCATION_ROUTE131:
        sRegionMap->mapSecId = MAPSEC_JOHTO_RADIO_TOWER;
        break;
    default:
...
{
    if (mapSecId == MAPSEC_JOHTO_SAFARI_ZONE_GATE)
...
static void CreateFlyDestIcons(void)
{
    ...
    for (mapSecId = MAPSEC_JOHTO_TWINRIVER_CITY; mapSecId <= MAPSEC_JOHTO_SPACE_HYPER_VESSEL; mapSecId++)
    {
