...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_JAVA_KEMBANG_TOWN] = {MAP_GROUP(ROUTE112), MAP_NUM(ROUTE112), HEAL_LOCATION_GENSOKYO_NAMELESS_HILL},
    ...
    [MAPSEC_JAVA_MALANG] = {MAP_GROUP(ROUTE131), MAP_NUM(ROUTE131), HEAL_LOCATION_INMAP0X2E},
    [MAPSEC_JAVA_DEVATA_ISLETS] = {MAP_GROUP(ROUTE132), MAP_NUM(ROUTE132), HEAL_LOCATION_INMAP0X2F},
    [MAPSEC_JAVA_KASEPUHAN_TOWN] = {MAP_GROUP(ROUTE133), MAP_NUM(ROUTE133), HEAL_LOCATION_INMAP0X30},
    [MAPSEC_JAVA_CILA_PRISON_TOWN] = {MAP_GROUP(ROUTE134), MAP_NUM(ROUTE134), HEAL_LOCATION_INMAP0X31},
};
