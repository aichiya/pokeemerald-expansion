...
{
    MAPSEC_REV_GENSOKYO_EASTERN_ROAD2,
    MAPSEC_REV_GENSOKYO_EASTERN_ROAD3,
    MAPSEC_REV_GENSOKYO_EASTERN_ROAD4,
    MAPSEC_REV_GENSOKYO_EASTERN_ROAD5,
    MAPSEC_REV_GENSOKYO_ROAD_OF_RECONSIDERATION1,
    MAPSEC_REV_GENSOKYO_ROAD_OF_RECONSIDERATION2,
    MAPSEC_REV_GENSOKYO_ROAD_OF_RECONSIDERATION3,
    MAPSEC_REV_GENSOKYO_ROAD_OF_RECONSIDERATION4,
    MAPSEC_REV_GENSOKYO_ROAD_OF_RECONSIDERATION5,
    MAPSEC_REV_GENSOKYO_ROAD_OF_LIMINATION1,
    MAPSEC_REV_GENSOKYO_ROAD_OF_LIMINATION2,
    MAPSEC_REV_GENSOKYO_ROAD_OF_LIMINATION3,
    MAPSEC_REV_GENSOKYO_ROAD_OF_LIMINATION4,
    MAPSEC_REV_GENSOKYO_ROAD_OF_LIMINATION5,
    ...
    MAPSEC_REV_YYYI_SANSHUU_SCHOOL,
    MAPSEC_REV_YYYI_SHINJUKAN_SCHOOL,
    ...
    MAPSEC_REV_BGHS_SHINJUGAMINE_SCHOOL,
...
static void CreateFlyDestIcons(void)
{
    ...
    for (mapSecId = MAPSEC_REV_JOHTO_TWINRIVER_CITY; mapSecId <= MAPSEC_REV_JOHTO_SPACE_HYPER_VESSEL; mapSecId++)
    {
