...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_JOHTO_ROUTE_48_POKEMON_CENTER] = {MAP_GROUP(ROUTE129), MAP_NUM(ROUTE129), HEAL_LOCATION_INMAP0X2C},
    [MAPSEC_JOHTO_NOBELESSE_CITY] = {MAP_GROUP(ROUTE130), MAP_NUM(ROUTE130), HEAL_LOCATION_INMAP0X2D},
