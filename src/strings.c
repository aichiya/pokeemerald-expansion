...
const u8 gText_CategoryDexName[] = _("");
...
const u8 gText_Pokedex[] = _("NC{EMOJI_CLOVER}PDA"); // Unused
...
const u8 gText_ThisIsAPokemon[] = _("…I will give this special egg to you.{PAUSE 96}\p");
const u8 gText_5MarksPokemon[] = _("????? World");
const u8 gText_UnkHeight[] = _(" ???.? m");
const u8 gText_UnkWeight[] = _(" ???.? pt");
...
const u8 gText_PokedexRegistration[] = _("NC{EMOJI_CLOVER}PDA registration completed.");
...
const u8 gText_SwitchPokedexListings[] = _("Switch NC{EMOJI_CLOVER}PDA listings.");
const u8 gText_ReturnToPokedex[] = _("Return to the NC{EMOJI_CLOVER}PDA.");
const u8 gText_SelectPokedexMode[] = _("Select the NC{EMOJI_CLOVER}PDA mode.");
const u8 gText_SelectPokedexListingMode[] = _("Select the NC{EMOJI_CLOVER}PDA listing mode.");
...
const u8 gText_DexHoennTitle[] = _("POKéDEX");
const u8 gText_DexNatTitle[] = _("ZENSEKAI DEX");
...
const u8 gText_DexHoennDescription[] = _("Only showing POKéMON in JOHTO");
const u8 gText_DexNatDescription[] = _("Including FRAGMON from other worlds");
...
const u8 gText_HOFDexRating[] = _("Spotted FRAGMON: {STR_VAR_1}!\nOwned FRAGMON: {STR_VAR_2}!\pPROF. BIRCH's FRAGMON rating!\pPROF. BIRCH: Let's see…\p");
...
const u8 gText_YinSymbol[] = _("6");
const u8 gText_YangSymbol[] = _("9");
...
const u8 gText_Moves[] = _("MOVES"); // Used for Party Menu
...
*/
const u8 gText_XNatureMetAtYZ[] = _("Nature: {DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}{DYNAMIC 6}{DYNAMIC 7}.\nMet at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1},\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}.");
const u8 gText_XNatureHatchedAtYZ[] = _("Nature: {DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}{DYNAMIC 6}{DYNAMIC 7}.\nHatched at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1},\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}.");
const u8 gText_XNatureObtainedInTrade[] = _("Nature: {DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}{DYNAMIC 6}{DYNAMIC 7}.\nObtained in a trade.");
const u8 gText_XNatureFatefulEncounter[] = _("Nature: {DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}{DYNAMIC 6}{DYNAMIC 7}.\nObtained in a fateful\nencounter at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}.");
const u8 gText_XNatureProbablyMetAt[] = _("Nature: {DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}{DYNAMIC 6}{DYNAMIC 7}.\nProbably met at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1},\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}.");
const u8 gText_XNature[] = _("Nature: {DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}{DYNAMIC 6}{DYNAMIC 7}.");
const u8 gText_XNatureMetSomewhereAt[] = _("Nature: {DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}{DYNAMIC 6}{DYNAMIC 7}.\nMet somewhere at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}.");
const u8 gText_XNatureHatchedSomewhereAt[] = _("Nature: {DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}{DYNAMIC 6}{DYNAMIC 7}.\nHatched somewhere at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}.");

const u8 gText_OddEggFoundByCouple[] = _("An odd FRAGMON EGG found\nby the DAY CARE couple.");
const u8 gText_PeculiarEggNicePlace[] = _("A peculiar FRAGMON EGG\nobtained at the nice place.");
const u8 gText_PeculiarEggTrade[] = _("A peculiar FRAGMON EGG\nobtained in a trade.");
const u8 gText_EggFromHotSprings[] = _("A FRAGMON EGG obtained\nat the hot springs.");
const u8 gText_EggFromTraveler[] = _("An odd FRAGMON EGG\nobtained from a traveler.");
...
const u8 gText_Poke_Balls[] = _("FRAG-BALLS");
...
const u8 gText_MenuOptionPokedex[] = _("NC{EMOJI_CLOVER}PDA");
const u8 gText_MenuOptionPokemon[] = _("FRAGMON");
const u8 gText_MenuOptionBag[] = _("BAG");
const u8 gText_MenuOptionPokenav[] = _("DECANAV");
...
const u8 gText_PyramidPokemon[] = _("PYRAMID: FRAGMON");
...
const u8 gText_PokenavAndBag[] = _("DECANAV AND BAG");
const u8 gText_HeldItems[] = _("HELD ITEMS");
const u8 gText_PokemonOrder[] = _("FRAGMON ORDER");
...
const u8 gText_ThatsYourLastPkmn[] = _("That's your last FRAGMON!");
const u8 gText_YourPartysFull[] = _("Your party's full!");
const u8 gText_YoureHoldingAPkmn[] = _("You're holding a FRAGMON!");
...
const u8 gText_WithdrawMonDescription[] = _("Move FRAGMON stored in BOXES to\nyour party.");
const u8 gText_DepositMonDescription[] = _("Store FRAGMON in your party in BOXES.");
const u8 gText_MoveMonDescription[] = _("Organize the FRAGMON in BOXES and\nin your party.");
const u8 gText_MoveItemsDescription[] = _("Move items held by any FRAGMON\nin a BOX or your party.");
const u8 gText_SeeYaDescription[] = _("Return to the previous menu.");
const u8 gText_JustOnePkmn[] = _("There is just one FRAGMON with you.");
...
const u8 gText_CheckPokemonInDetail[] = _("Check FRAGMON in detail.");
...
const u8 gText_PutAwayPokenav[] = _("Put away the DECANAV.");
...
const u8 gText_CheckPartyPokemonInDetail[] = _("Check party FRAGMON in detail.");
const u8 gText_CheckAllPokemonInDetail[] = _("Check all FRAGMON in detail.");
const u8 gText_ReturnToPokenavMenu[] = _("Return to the DECANAV menu.");
const u8 gText_FindCoolPokemon[] = _("Find cool FRAGMON.");
const u8 gText_FindBeautifulPokemon[] = _("Find beautiful FRAGMON.");
const u8 gText_FindCutePokemon[] = _("Find cute FRAGMON.");
const u8 gText_FindSmartPokemon[] = _("Find smart FRAGMON.");
const u8 gText_FindToughPokemon[] = _("Find tough FRAGMON.");
...
const u8 gText_PokenavMatchCall_TrainerPokemon[] = _("TRAINER'S FRAGMON");
...
const u8 gText_PokemonLeague[] = _("FRAGMON LEAGUE");
...
const u8 gText_TrainerCardPokedex[] = _("NC{EMOJI_CLOVER}PDA");
...
const u8 gText_HealthboxGender_Yin[] = _("{COLOR DYNAMIC_COLOR2}6");
const u8 gText_HealthboxGender_Yang[] = _("{COLOR DYNAMIC_COLOR1}9");
...
const u8 gText_MatchCallSteven_Pokemon[] = _("Ultimate STEEL FRAGMON.");
...
const u8 gText_MatchCallBrendan_Pokemon[] = _("I will use various FRAGMON.");
const u8 gText_MatchCallBrendan_Intro1[] = _("I'll be a better FRAGMON");
...
const u8 gText_MatchCallMay_Pokemon[] = _("I'll use any FRAGMON!");
const u8 gText_MatchCallMay_Intro1[] = _("My FRAGMON and I help");
...
const u8 gText_ContinueMenuPokedex[] = _("NC{EMOJI_CLOVER}PDA");
...
const u8 gText_MenuPokedex[] = _("NC{EMOJI_CLOVER}PDA");
const u8 gText_MenuPokemon[] = _("FRAGMON");
const u8 gText_MenuBag[] = _("BAG");
const u8 gText_MenuPokenav[] = _("DECANAV");
...
const u8 gText_PokemonOnHook[] = _("A FRAGMON's on the hook!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_SavingPokedex[] = _("NC{EMOJI_CLOVER}PDA");
